/******************************************************************************
**  Name: qproject_get_task_selectlist_contract
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].qproject_get_task_selectlist_contract') and xtype in (N'FN', N'IF', N'TF'))
drop function [dbo].qproject_get_task_selectlist_contract
GO
...
CREATE FUNCTION qproject_get_task_selectlist_contract(
