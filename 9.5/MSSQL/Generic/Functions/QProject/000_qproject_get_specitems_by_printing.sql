...
BEGIN
  ...
  INTO @v_taqversionformatyearkey, @v_printingnumber, @v_yearcode, @v_taqprojectkey, @v_plstagecode, @v_taqversionkey, @v_taqprojectformatkey
  ...
  BEGIN
    ...
    -- Get all specs: first part of the union are specs sitting directly on the project, second part are specs on related project
    DECLARE taqversionspeccategory_cur CURSOR FOR       
      SELECT taqversionspecategorykey, taqversionspecategorykey, itemcategorycode, speccategorydescription, 
      ...
      WHERE taqprojectkey = @v_taqprojectkey
        ...
        AND COALESCE(relatedspeccategorykey,0) = 0 
      UNION
      SELECT c.taqversionspecategorykey, c.relatedspeccategorykey, c2.itemcategorycode, c2.speccategorydescription, 
    ...
    INTO @v_taqversionspecategorykey, @v_relatedspeccategorykey, @v_itemcategorycode, @v_speccategorydescription, 
      @v_scaleprojecttype, @v_vendorcontactkey
