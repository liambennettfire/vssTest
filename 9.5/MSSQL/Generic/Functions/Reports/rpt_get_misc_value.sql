IF exists (select * from dbo.sysobjects where id = object_id(N'rpt_get_misc_value') )
DROP FUNCTION dbo.rpt_get_misc_value
GO
...
CREATE FUNCTION rpt_get_misc_value
(
...
BEGIN 
  DECLARE
    ...
    @v_floatvalue FLOAT,
    @v_formatted_value  VARCHAR(4000),
    @v_longvalue  INT,
    @v_misctype INT,
...
grant execute on rpt_get_misc_value to public
go
