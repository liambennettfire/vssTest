...
/****** Object:  UserDefinedFunction [dbo].[rpt_get_gentables_field]    Script Date: 12/09/2014 09:48:19 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[rpt_get_gentables_field]') AND type in (N'FN', N'IF', N'TF', N'FS', N'FT'))
...
grant all on [rpt_get_gentables_field] to public