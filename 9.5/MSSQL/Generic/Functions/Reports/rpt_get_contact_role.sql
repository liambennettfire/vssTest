...
if exists (select * from dbo.sysobjects where id = object_id(N'rpt_get_contact_role') and xtype in (N'FN', N'IF', N'TF'))
  drop function rpt_get_contact_role
GO

CREATE FUNCTION rpt_get_contact_role
...
grant execute on rpt_get_contact_role to public
go
