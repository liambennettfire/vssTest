if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_misc_datacode_value') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qtitle_get_misc_datacode_value
GO

CREATE FUNCTION dbo.qtitle_get_misc_datacode_value
(
...
/*******************************************************************************************************
**  Name: qtitle_get_misc_datacode_value
**  Desc: This function returns the miscellaneous gentables datacode value for specific Title as an integer.
**
**  Auth: Uday A. Khisty
**  Date: April 9 2015
*******************************************************************************************************/
...
GRANT EXEC ON dbo.qtitle_get_misc_datacode_value TO public
GO
