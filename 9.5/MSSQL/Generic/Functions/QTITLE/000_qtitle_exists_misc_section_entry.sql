if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_exists_misc_section_entry') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qtitle_exists_misc_section_entry
GO

CREATE FUNCTION dbo.qtitle_exists_misc_section_entry
(
...
/*******************************************************************************************************
**  Name: qtitle_exists_misc_section_entry
...
GRANT EXEC ON dbo.qtitle_exists_misc_section_entry TO public
GO
