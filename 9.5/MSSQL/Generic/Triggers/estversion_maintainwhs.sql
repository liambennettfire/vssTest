...
IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'estversion_maintainwhs')
	DROP TRIGGER estversion_maintainwhs
GO

CREATE TRIGGER estversion_maintainwhs ON estversion
