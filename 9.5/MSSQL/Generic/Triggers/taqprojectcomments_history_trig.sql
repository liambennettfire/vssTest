IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'taqprojectcomments_history')
	BEGIN
		DROP  Trigger dbo.taqprojectcomments_history
	END
GO

CREATE TRIGGER [dbo].taqprojectcomments_history ON [dbo].taqprojectcomments
