...
CREATE PROCEDURE qpl_calc_yr_tot_inc (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
  @i_yearcode   INT,
...
BEGIN
  ...
  EXEC qpl_calc_yr_sub_rights_inc @i_projectkey, @i_plstage, @i_plversion, @i_yearcode, @v_subrights_income OUTPUT
...
GRANT EXEC ON qpl_calc_yr_tot_inc TO PUBLIC
GO
