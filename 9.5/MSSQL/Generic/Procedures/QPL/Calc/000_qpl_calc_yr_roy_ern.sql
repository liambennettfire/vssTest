if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc053') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc053
GO

if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_yr_roy_ern') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_yr_roy_ern
GO

CREATE PROCEDURE qpl_calc_yr_roy_ern (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
  @i_yearcode   INT,
