if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc020') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc020
GO
...
CREATE PROCEDURE qpl_calc_ver_bulk_sales (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
...
GRANT EXEC ON qpl_calc_ver_bulk_sales TO PUBLIC
GO
