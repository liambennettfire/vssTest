if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_supply_chain_related_title_info') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure dbo.qtitle_get_supply_chain_related_title_info
GO
...
CREATE PROCEDURE qtitle_get_supply_chain_related_title_info
 (@i_workkey  integer,
  @i_bookkey  integer = 0,
...
/******************************************************************************
**  Name: qtitle_get_supply_chain_related_title_info
**  Desc: This stored procedure gets a list of titles to relate 
**        to (used in Establish Supply Chain).
**
**  Auth: Alan Katzen
**  Date: 4 August 2010
**
*******************************************************************************/
  ...
  if @i_bookkey > 0 begin
    ...
    SELECT DISTINCT c.bookkey, c.title, c.ean, c.productnumber, c.mediatypecode, 
...
GRANT EXEC ON qtitle_get_supply_chain_related_title_info TO PUBLIC
GO
