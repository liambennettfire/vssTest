...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_100013041001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_100013041001]
GO

CREATE PROCEDURE dbo.imp_100013041001 
...
BEGIN
	...
	INSERT INTO imp_batch_detail(batchkey,row_id,elementkey,elementseq,originalvalue,lastuserid,lastmaintdate)
    	VALUES (@i_batchkey,@i_row,100013023,@v_new_seq,@v_new_value ,'loader_rule_100013041001',getdate())

	INSERT INTO imp_batch_detail(batchkey,row_id,elementkey,elementseq,originalvalue,lastuserid,lastmaintdate)
    	VALUES (@i_batchkey,@i_row,100013024,@v_new_seq,@v_pricetype ,'loader_rule_100013041001',getdate())

	INSERT INTO imp_batch_detail(batchkey,row_id,elementkey,elementseq,originalvalue,lastuserid,lastmaintdate)
	VALUES (@i_batchkey,@i_row,100013026,@v_new_seq,'U.S. Dollars','loader_rule_100013041001',getdate())

	INSERT INTO imp_batch_detail(batchkey,row_id,elementkey,elementseq,originalvalue,lastuserid,lastmaintdate)
	VALUES (@i_batchkey,@i_row,100013028,@v_new_seq,@v_effdate,'loader_rule_100013041001',getdate())
...
GRANT EXECUTE ON dbo.[imp_100013041001] to PUBLIC 
GO
