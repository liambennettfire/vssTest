/******************************************************************************
**  Name: imp_300026041001
**  Desc: IKE author addr line 2
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_300026041001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_300026041001]
GO

CREATE PROCEDURE dbo.imp_300026041001
...
BEGIN
  ...
  set @v_errcode = 1
  set @v_errmsg = 'Author (1st) Address Line 2'
...
GRANT EXECUTE ON dbo.[imp_300026041001] to PUBLIC 
GO
