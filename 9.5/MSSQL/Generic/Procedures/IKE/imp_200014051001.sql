/******************************************************************************
**  Name: imp_200014051001
**  Desc: IKE Series Validation
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_200014051001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_200014051001]
GO

CREATE PROCEDURE dbo.imp_200014051001 
...
BEGIN
	...
	IF @v_datacode is null	
		BEGIN
			SET @v_errlevel = 2
			SET @v_errmsg = 'Can not find ('+@v_elementval+') value on  User Table(327) for '+@v_elementdesc
		END
	ELSE
		BEGIN
...
GRANT EXECUTE ON dbo.[imp_200014051001] to PUBLIC 
GO
