/******************************************************************************
**  Name: imp_300026147001
**  Desc: IKE author phone update
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_300026147001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_300026147001]
GO

CREATE PROCEDURE dbo.imp_300026147001
...
BEGIN
  ...
  if coalesce(@v_orgval,'')<>coalesce(@v_elementval,'')
    begin
      ...
      set @v_errmsg='Author Phone 2 updated'
    end
  else
    begin
      set @v_errmsg='Author Phone 2 unchanged'
    end
...
GRANT EXECUTE ON dbo.[imp_300026147001] to PUBLIC 
GO
