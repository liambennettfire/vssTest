...
**    --------    --------        -------------------------------------------
**    08/01/16    SLB             Update to set gentablesdesc.refreshcacheind = 1 
**                                so chache will be refreshed and new gentables 
**                                available   
*******************************************************************************/
...
BEGIN
  ...
  SET @o_datacode = 0 
  UPDATE gentablesdesc SET refreshcacheind = 1 where tableid = @i_tableid
