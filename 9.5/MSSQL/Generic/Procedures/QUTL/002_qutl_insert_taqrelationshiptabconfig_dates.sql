...
/****** Object:  StoredProcedure [dbo].[qutl_insert_taqrelationshiptabconfig_dates]    Script Date: 01/09/2015 11:56:09 ******/
SET ANSI_NULLS ON
GO
...
IF EXISTS(SELECT * FROM sys.objects WHERE type = 'p' and name = 'qutl_insert_taqrelationshiptabconfig_dates' ) 
drop procedure qutl_insert_taqrelationshiptabconfig_dates
go

CREATE PROCEDURE [dbo].[qutl_insert_taqrelationshiptabconfig_dates]
...
/***********************************************************************************************
**  Name: qutl_insert_taqrelationshiptabconfig_dates
...
BEGIN
   ...
   IF @i_tabdate_order = 1
       UPDATE taqrelationshiptabconfig SET date1label = @i_datetablabel, datetypecode1 = @v_datetypecode 
       WHERE @o_taqrelationshipconfigkey = taqrelationshiptabconfigkey
   ELSE IF @i_tabdate_order = 2
       UPDATE taqrelationshiptabconfig SET date2label = @i_datetablabel, datetypecode2 = @v_datetypecode 
       WHERE @o_taqrelationshipconfigkey = taqrelationshiptabconfigkey
   ELSE IF @i_tabdate_order = 3
       UPDATE taqrelationshiptabconfig SET date3label = @i_datetablabel, datetypecode3 = @v_datetypecode 
       WHERE @o_taqrelationshipconfigkey = taqrelationshiptabconfigkey      
   ELSE IF @i_tabdate_order = 4
       UPDATE taqrelationshiptabconfig SET date4label = @i_datetablabel, datetypecode4 = @v_datetypecode 
       WHERE @o_taqrelationshipconfigkey = taqrelationshiptabconfigkey   
    ELSE IF @i_tabdate_order = 3
       UPDATE taqrelationshiptabconfig SET date5label = @i_datetablabel, datetypecode5 = @v_datetypecode 
       WHERE @o_taqrelationshipconfigkey = taqrelationshiptabconfigkey   
    ELSE IF @i_tabdate_order = 3
       UPDATE taqrelationshiptabconfig SET date6label = @i_datetablabel, datetypecode6 = @v_datetypecode 
       WHERE @o_taqrelationshipconfigkey = taqrelationshiptabconfigkey   
...
GO
GRANT EXEC ON qutl_insert_taqrelationshiptabconfig_dates TO PUBLIC
GO
