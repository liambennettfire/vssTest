...
BEGIN
  ...
  BEGIN
    ...
    CAST('' AS VARCHAR(400)) as fromtitle, CONVERT(DATETIME, NULL, 101) fromorigdate, CONVERT(DATETIME, NULL, 101) fromreviseddate,
    CASE
    ...
    BEGIN
      ...
      BEGIN
        SELECT @v_fromtitle = c.title + '/' + c.formatname
      ...
      BEGIN
        ...
        SET fromtitle = @v_fromtitle, fromorigdate = @v_fromorigdate, fromreviseddate = @v_fromreviseddate
