...
if @i_verificationtypecode in(2,3) begin
	...
	set @v_messagecategorycode = @v_Information
	
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Information, 'Missing Book Title Prefix',@i_username, getdate(), @v_messagecategorycode)
	end 
end
end
...
if @i_verificationtypecode in(2) begin
	...
	set @v_messagecategorycode = @v_Warning
	
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing BISAC Status Code',@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end 
end
if @i_verificationtypecode in(3) begin
	...
	set @v_messagecategorycode = @v_Error
	
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing BISAC Status Code',@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
if @i_verificationtypecode in(3) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Product Availability Code',@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
    end
end
...
if @i_verificationtypecode in(2) begin
	...
	set @v_messagecategorycode = @v_Warning
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Discount Code',@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end 
end
end
...
if @i_verificationtypecode in(3) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Discount Code',@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
set @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Book Media'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end 
end
...
if @v_mediatypecode is not null begin
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Eloquence Field tag for Media'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
	end 
end
end
...
set @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Book Format'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end 
end
...
if @v_mediatypesubcode is not null and @v_mediatypecode is not null begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Eloquence Field tag for Format'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
		...
		if @v_agelowupind is null or @v_agelowupind = 0 begin
			...
			if @i_write_msg = 1 begin
				...
				set @v_messagecategorycode = @v_Warning
					...
					exec get_next_key @i_username, @v_nextkey out
					insert into bookverificationmessage
					values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Age Range - Age Low',@i_username, getdate(), @v_messagecategorycode)
					set @v_varnings = 1
				end 
			end
			if @v_agehighupind is null or @v_agehighupind = 0 begin
				...
				if @i_write_msg = 1 begin
					...
					set @v_messagecategorycode = @v_Warning
						...
						exec get_next_key @i_username, @v_nextkey out
						insert into bookverificationmessage
						values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Age Range - Age High',@i_username, getdate(), @v_messagecategorycode)
						set @v_varnings = 1
					end
				end
			end 
...
if @i_verificationtypecode = 2 begin --elo only
   ...
   BEGIN
		if @v_gradelowupind is null or @v_gradelowupind = 0 begin
			...
			set @v_messagecategorycode = @v_Warning
				...
				exec get_next_key @i_username, @v_nextkey out
				insert into bookverificationmessage
				values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Grade Level - Grade Low',@i_username, getdate(), @v_messagecategorycode)
				set @v_varnings = 1
			end 
		end
		end
   ...
   BEGIN
		if @v_gradehighupind is null or @v_gradehighupind = 0  begin
			...
			set @v_messagecategorycode = @v_Warning
				...
				exec get_next_key @i_username, @v_nextkey out
				insert into bookverificationmessage
				values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Grade Level - Grade High',@i_username, getdate(), @v_messagecategorycode)
				set @v_varnings = 1
			end 
		end
		end
   ...
   BEGIN
      ...
      set @v_messagecategorycode = @v_Warning
			...
			exec get_next_key @i_username, @v_nextkey out
			insert into bookverificationmessage
				values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'It is not valid to use JUV and Non JUV BISAC Subjects on a single title',@i_username, getdate(), @v_messagecategorycode)
			set @v_varnings = 1
		END
	END
end
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Series'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end 
end
/*
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Volume Number'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end 
...
if @i_verificationtypecode in(3,4) begin
	...
	set @v_messagecategorycode = @v_Warning
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Edition Type'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end 
end
if @i_verificationtypecode in(3,4) begin
	...
	set @v_messagecategorycode = @v_Warning
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Edition #'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end 
end
*/
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Edition Description'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end 
end
...
if @i_verificationtypecode in(3,4) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Return Code'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Language'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end
end
/* 
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Second Language'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end 
*/
...
set @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Book Title' + @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end 
end
...
set @v_messagecategorycode = @v_Information
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Information, 'Missing Book Title Subtitle'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
end 
end
...
if @i_write_msg = 1 begin
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Primary Author'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
	end 
end
...
if @i_write_msg = 1 begin
	if @v_cnt > 0 begin
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Eloquence Field tag for Author'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
		end 
	end
end	
...
--      exec get_next_key @i_username, @v_nextkey out
--      insert into bookverificationmessage
--      values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing ISBN',@i_username, getdate(), @v_messagecategorycode)
--      set @v_failed = 1
--   end 
--end
--end
...
--	exec get_next_key @i_username, @v_nextkey out
--	insert into bookverificationmessage
--	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Information, 'Missing ISBN10'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
--	set @v_failed = 1
--end 
--end
...
--		exec get_next_key @i_username, @v_nextkey out
--		insert into bookverificationmessage
--		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing EAN13'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
--		set @v_failed = 1
--	end 
--	end
--end
...
--		exec get_next_key @i_username, @v_nextkey out
--		insert into bookverificationmessage
--		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing EAN'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
--		set @v_failed = 1
--	end 
--	end
--end
...
IF @v_err_desc <> '' BEGIN
  ...
  exec get_next_key @i_username, @v_nextkey out
  insert into bookverificationmessage
  values (@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error,  @v_err_desc , @i_username, getdate(), @v_messagecategorycode)
END
...
SET @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing PUB Date'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end 
end
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing PUB Date'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end 
end
end
...
if @v_bestdate is null begin
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Information, 'Missing On Sale Date'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
end 
end
...
if @i_verificationtypecode in(4) begin
	...
	set @v_messagecategorycode = @v_Warning
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Total vol in Series'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end 
end
end
...
set @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Carton Qty/Case Pack'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end
end 
if @i_verificationtypecode in(2,4) begin
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Carton Qty/Case Pack'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end
end 
end
	...
	if @v_trimsizelength is null or @v_trimsizelength = '' begin
		if  @v_esttrimsizelength is null or @v_esttrimsizelength = '' begin 
			...
			set @v_messagecategorycode = @v_Error
				...
				exec get_next_key @i_username, @v_nextkey out
				insert into bookverificationmessage
				values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Height'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
				set @v_failed = 1
			end
		end
	end
	...
	if @v_trimsizewidth is null or @v_trimsizewidth = '' begin
		if  @v_esttrimsizewidth is null or @v_esttrimsizewidth = '' begin 
			...
			set @v_messagecategorycode = @v_Error
				...
				exec get_next_key @i_username, @v_nextkey out
				insert into bookverificationmessage
				values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Width'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
				set @v_failed = 1
			end
		end
	end 
...
if @i_verificationtypecode in(4) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Depth (spine size)'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
if @i_verificationtypecode in(3) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Bar Code Indicator',@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end
end
end
...
if @i_verificationtypecode in(4) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Weight'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
if @v_eloquencefieldtag in('B') begin
	...
	set @v_messagecategorycode = @v_Warning
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Page Cnt'+ @v_g_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end 
end
end
...
if @v_eloquencefieldtag in('A', 'D', 'F', 'V') begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Running Time',@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
set @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing BISAC Subject 1'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end 
end
if @i_verificationtypecode in(2,4) begin
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing BISAC Subject 1'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end 
end
end
...
if @i_write_msg = 1 begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
			values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Active Price'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end
end
     ...
     IF @v_cnt2 = 0 BEGIN
		  ...
		  if @i_write_msg = 1 begin
			  ...
			  set @v_messagecategorycode = @v_Error
				  ...
				  exec get_next_key @i_username, @v_nextkey out
				  insert into bookverificationmessage
				  values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Acive Price'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
				  set @v_failed = 1
			  end
		  end
	  END
...
if @i_verificationtypecode in(1) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Price Type'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end
end
end
...
if @i_verificationtypecode in(4) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Canadian Price'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end
end
end
...
if @i_verificationtypecode in(3) begin
	...
	set @v_messagecategorycode = @v_Information
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Information, 'Missing Territorial Rights',@i_username, getdate(), @v_messagecategorycode)
	end 
end
end
...
if @i_verificationtypecode = 2 begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Eloquence Customer',@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end 
end
end
...
if @i_verificationtypecode in(3) begin
	...
	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Audience'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
	end
end
end
...
set @v_messagecategorycode = @v_Error
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Publisher'+ @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_failed = 1
end
end
...
set @v_messagecategorycode = @v_Warning
	...
	exec get_next_key @i_username, @v_nextkey out
	insert into bookverificationmessage
	values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Imprint' + @v_bsg_msg,@i_username, getdate(), @v_messagecategorycode)
	set @v_varnings = 1
end
end
...
if @i_verificationtypecode in(3) begin
	...
	(associationtypecode = 4 and associationtypesubcode = 4))
  	...
  	set @v_messagecategorycode = @v_Error
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Error, 'Missing Replaces/Replaced By, edition # is 2 or higher' ,@i_username, getdate(), @v_messagecategorycode)
		set @v_failed = 1
...
if @v_subgen1ind = 1 begin
	...
	set @v_messagecategorycode = @v_Warning
		...
		exec get_next_key @i_username, @v_nextkey out
		insert into bookverificationmessage
		values(@v_nextkey, @i_bookkey, @i_verificationtypecode, @v_Warning, 'Missing Expected Ship Date ',@i_username, getdate(), @v_messagecategorycode)
		set @v_varnings = 1
	end
end
end
