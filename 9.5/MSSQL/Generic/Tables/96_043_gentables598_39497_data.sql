...
BEGIN
  ...
  FROM gentables
  WHERE tableid = 598 AND qsicode = 28
  ...
  BEGIN  
	...
	VALUES
	  (598, @v_max_code, 'Classification', 'N', @v_max_sortorder, 'CopyClassification', 'Classification', 'QSIDBA', getdate(),
	  0, 1, 0, 0, 1, 0, 'Copy the Classification.', 28)
  END
END
go