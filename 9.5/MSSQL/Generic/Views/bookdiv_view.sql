...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[bookdiv_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[bookdiv_view]
GO


/****** Object:  View dbo.bookdiv_view    Script Date: 5/22/2000 4:22:18 PM ******/
CREATE VIEW dbo.bookdiv_view 
...
where filterorglevel.filterkey=8 and
...
GRANT  SELECT ,  UPDATE ,  INSERT ,  DELETE  ON [dbo].[bookdiv_view]  TO [public]
GO
