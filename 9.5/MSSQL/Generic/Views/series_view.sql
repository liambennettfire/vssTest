...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[series_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[series_view]
GO
...
GRANT  SELECT ,  UPDATE ,  INSERT ,  DELETE  ON [dbo].[series_view]  TO [public]
GO
