IF EXISTS (SELECT * FROM dbo.sysobjects WHERE id = Object_id('temp_sgt_bisaccodes_29') AND type = 'U')
  BEGIN
    DROP table temp_sgt_bisaccodes_29
  END
go


CREATE TABLE temp_sgt_bisaccodes_29  (
	Code char(255),
	Literal char(255))   
go

INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'ANT000000',
	'General')
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM012040',
	'Computer Graphics / Game Programming & Design')
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM012050',
	'Computer Graphics / Image Processing (see also PHOTOGRAPHY / Techniques / Digital)')
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM013000',
	'Computer Literacy')
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM020020',
	'Data Transmission Systems / Messaging')
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM020090',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM051260',
	'Programming Languages / JavaScript & VBScript')
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'COM051100',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'JUV051000',
	'Imagination & Play (see also JUVENILE NONFICTION / Poetry / Nursery Rhymes)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'JUV020000',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'JNF042020',
	'Poetry / Nursery Rhymes (see also JUVENILE FICTION / Imagination & Play)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'JNF045000',
	'Readers / Beginner')  
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'PHO024000',
	'Techniques / Digital (see also COMPUTERS / Computer Graphics / Image Processing)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'PHO007000',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006110',
	'Bible / Meditations / General')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006120',
	'Bible / Meditations / Old Testament')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006130',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006510',
	'Bibles / International Children''s')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006280',
	'Bibles / King James')  
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006300',
	'Bibles / New American Standard')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006550',
	'Bibles / New American Standard Update')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006640',
	'Bibles / New Century')  
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006570',
	'Bibles / New International Readers')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL006340',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL007000',
	'Buddhism / General (see also PHILOSOPHY / Eastern / Buddhism)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL007010',
	'Buddhism / History')  
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL092000',
	'Buddhism / Zen (see also PHILOSOPHY / Eastern / Zen)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL070000',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL046000',
	'Christianity / Church of Jesus Christ of Latter-Day Saints (Mormonism)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL094000',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL055000',
	'Christianity / Rituals & Practice')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL098000',
	'Christianity / Seventh-Day Adventists')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL059000',
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL065000',
	'Taoism (see also PHILOSOPHY / Eastern / Taoism)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'REL066000',
	'Theism')  
...
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'STU024000',
	'SAT & PSAT (Scholastic Assessment Test & Preliminary Scholastic Assessment Test)')  
go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'STU025000',
	'SSAT & COOP (Secondary School Admission Test & Cooperative Admissions Examination)') 
 go
INSERT INTO temp_sgt_bisaccodes_29 VALUES (
	'STU026000',
	'Study Guides')  
