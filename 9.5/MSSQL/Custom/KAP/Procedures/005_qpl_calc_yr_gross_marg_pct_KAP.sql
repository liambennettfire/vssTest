...
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_yr_gross_marg_pct_KAP') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_yr_gross_marg_pct_KAP
GO

CREATE PROCEDURE qpl_calc_yr_gross_marg_pct_KAP (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion  INT,
  @i_yearcode   INT,
...
/******************************************************************************************
**  Name: qpl_calc_yr_gross_marg_pct_KAP
...
BEGIN
  ...
  -- Year - Gross Margin
  EXEC qpl_calc_yr_gross_marg_KAP @i_projectkey, @i_plstage, @i_plversion, @i_yearcode, @v_gross_margin OUTPUT
...
GRANT EXEC ON qpl_calc_yr_gross_marg_pct_KAP TO PUBLIC
GO
