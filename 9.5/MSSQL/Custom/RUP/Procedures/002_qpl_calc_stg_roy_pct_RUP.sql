if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_stg_roy_pct_RUP') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_stg_roy_pct_RUP
GO

CREATE PROCEDURE qpl_calc_stg_roy_pct_RUP (  
  @i_projectkey INT,
  @i_plstage    INT,
...
BEGIN
  ...
  EXEC qpl_calc_stg_roy_adv @i_projectkey, @i_plstage, @v_royalty_adv OUTPUT
...
GRANT EXEC ON qpl_calc_stg_roy_pct_RUP TO PUBLIC
GO
