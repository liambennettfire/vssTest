if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_stg_tot_inc_RUP') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_stg_tot_inc_RUP
GO

CREATE PROCEDURE qpl_calc_stg_tot_inc_RUP (  
  @i_projectkey INT,
  @i_plstage    INT,
...
/******************************************************************************************
**  Name: qpl_calc_stg_tot_inc_RUP
**  Desc: Island Press Item 7 - Stage/TOTAL Income for Rutgers.  Removed Subsiary Rights and
**        Production Subsidy Income               
**
**  Auth: SLB
...
GRANT EXEC ON qpl_calc_stg_tot_inc_RUP TO PUBLIC
GO
