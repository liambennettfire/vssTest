IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[qpl_Calc_ver_COGS_IP]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[qpl_Calc_ver_COGS_IP]
GO




/****** Object:  StoredProcedure [dbo].[qpl_Calc_ver_COGS_IP]    Script Date: 7/31/2014 2:51:41 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE [dbo].[qpl_Calc_ver_COGS_IP] (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion  INT,  
...
GRANT ALL ON qpl_Calc_ver_COGS_IP TO PUBLIC
