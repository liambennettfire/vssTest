...
BEGIN
	...
	Select distinct g.globalcontactkey, UNL.dbo.get_gentables_desc(134,ba.authortypecode,''),ba.authortypecode
	from UNL..globalcontact g, UNL..bookauthor ba
	where ba.authorkey = g.globalcontactkey
	and ba.bookkey IN (Select bookkey from UNL..bookdetail where publishtowebind = 1)
