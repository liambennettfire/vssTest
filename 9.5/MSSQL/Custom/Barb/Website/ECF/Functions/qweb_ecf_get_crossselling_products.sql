if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].qweb_ecf_get_crossselling_products') and xtype in (N'FN', N'IF', N'TF'))
...
CREATE FUNCTION qweb_ecf_get_crossselling_products(
  @i_bookkey        integer)
