IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[ProductSearchByAdvancedFilterNew]') AND type in (N'P', N'PC'))
  DROP PROCEDURE [dbo].[ProductSearchByAdvancedFilterNew]
GO

/****** Object:  StoredProcedure [dbo].[ProductSearchByAdvancedFilterNew]    Script Date: 03/10/2009 15:43:25 ******/
SET ANSI_NULLS ON
GO
