...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[eloschupdatecomments_sp]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[eloschupdatecomments_sp]
GO



CREATE proc [dbo].eloschupdatecomments_sp 
