...
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_stg_gross_marg_pct_TAMU') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_stg_gross_marg_pct_TAMU
GO

CREATE PROCEDURE qpl_calc_stg_gross_marg_pct_TAMU (  
  @i_projectkey INT,
  @i_plstage    INT,
...
/******************************************************************************************
**  Name: qpl_calc_stg_gross_marg_pct_TAMU
...
GRANT EXEC ON qpl_calc_stg_gross_marg_pct_TAMU TO PUBLIC
GO
