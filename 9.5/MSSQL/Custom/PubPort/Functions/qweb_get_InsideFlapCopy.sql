...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[qweb_get_InsideFlapCopy]') and xtype in (N'FN', N'IF', N'TF'))
drop function [dbo].[qweb_get_InsideFlapCopy]
GO
