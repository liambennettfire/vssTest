...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_DateTypeCode') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_DateTypeCode
GO

CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_DateTypeCode
@bookkey        int,
@datetypecode   int,
