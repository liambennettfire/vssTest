...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_Price_NonExistentIgnoreEmpty') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_Price_NonExistentIgnoreEmpty
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_Price_NonExistentIgnoreEmpty
@bookkey        int,
@pricecode      int,
@currencycode   int,
...
if @count1 = 0 begin
	...
	if isnumeric(@fld_buffer) = 1 begin
