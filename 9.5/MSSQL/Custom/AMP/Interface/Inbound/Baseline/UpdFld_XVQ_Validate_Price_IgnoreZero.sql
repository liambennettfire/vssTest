...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_Price_IgnoreZero') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_Price_IgnoreZero
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_Price_IgnoreZero
@bookkey        int,
@pricecode      int,
@currencycode   int,
...
if @count1 = 0 begin
	...
	if len(ltrim(@fld_buffer)) = 0 OR convert(money,@fld_buffer) = 0.00 begin
