...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_Table_Number_ErrorEmpty') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_Table_Number_ErrorEmpty
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_Table_Number_ErrorEmpty
@bookkey        int,
