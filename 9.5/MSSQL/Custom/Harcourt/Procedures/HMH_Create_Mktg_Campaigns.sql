...
/******************************************************************************
**  Name: HMH_Create_Mktg_Campaigns
**  Desc: 
**  Auth: 
**  Date: 
*******************************************************************************
				...
				BEGIN
					...
					BEGIN
						...
						IF NOT EXISTS (
							...
							WHERE Ean13 = @v_ean13)
						BEGIN
							SET @v_message = 'No Bookkey for ISBN ' + COALESCE(@v_ean13, '')
						...
						BEGIN
							...
							BEGIN
								SET @v_message = 'Campaign Already Exists for ISBN ' + COALESCE(@v_ean13, '')
								EXEC [dbo].[write_qsijobmessage]	@qsibatchkey,
																	@qsijobkey,
																	@i_JobTypeCode,
																	0,
