/****** Object:  StoredProcedure [dbo].[rpt_BUILD_rpt_taq_plsummaryitem_by_versionyear]    Script Date: 04/13/2010 10:19:31 ******/
...
Select distinct d.plsummaryitemkey, d.fieldformat as fieldformat_version, d.assocplsummaryitemkey as plsummaryitemkey_version
into #tempindex 
from plsummaryitemdefinition d 
where d.summarylevelcode = 4 
and d.activeind = 1
