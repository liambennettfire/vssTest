...
create view dbo.pricetype_view(tableid, datacode, datadesc, deletestatus, applid, sortorder, tablemnemonic, externalcode, datadescshort, lastuserid, lastmaintdate, numericdesc1, numericdesc2)  as 
  select 
    ...
    from dbo.gentables
    where (dbo.gentables.tableid = 306)
