...
**    --------    --------    -------------------------------------------
**    04/20/2016   UK          Case 37482
**    08/04/2016   Colman      Case 37498 - Don't null out contact for tasks with actualind=1
*******************************************************************************/
...
BEGIN
  ...
  ************************************************************************************/
  ...
  IF @v_isPrinting = 1
  BEGIN
	SET @i_bookkey = @v_bookkey
	SET @i_printingkey = @v_printingkey
	SET @i_projectkey = NULL
  END  
