...
BEGIN
  ...
  BEGIN
    ...
    WHERE t.taqprojectkey = @i_projectkey
      ...
      AND COALESCE(r.taqversionformatkey,0) = @i_taqversionformatkey
    ...
    BEGIN
      ...
      IF NOT EXISTS (SELECT * FROM taqprojectcontactrole WHERE taqprojectcontactkey = @v_taqprojectcontactkey AND 
           ...
           AND shippingmethodcode = @i_shippingmethodcode AND COALESCE(taqversionformatkey,0) = @i_taqversionformatkey) 
      BEGIN  
        ...
        INSERT INTO taqprojectcontactrole
          ...
          quantity, shippingmethodcode, globalcontactrelationshipkey, indicator, taqversionformatkey, lastuserid, lastmaintdate)
        VALUES(@v_taqprojectcontactrolekey, @v_taqprojectcontactkey, @i_projectkey, @i_rolecode, 1,
          @i_quantity, @i_shippingmethodcode, @i_globalcontactrelationshipkey, @i_indicator, @i_taqversionformatkey, @i_userid, GETDATE())  
  ...
  IF @i_rolecode <>   @v_shipping_location_rolecode 
  BEGIN
