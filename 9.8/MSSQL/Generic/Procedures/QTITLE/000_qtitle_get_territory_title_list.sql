...
**    --------    --------       ---------------------------------------------------------------
**    08/30/2016  Colman         Case 39094 Return overridepropagationind
*******************************************************************************/
	DECLARE @v_error			INT,
          @v_rowcount		INT
  ...
  SELECT c.bookkey, c.printingkey, tr.territoryrightskey, coalesce(tr.overridepropagationind,0) overridepropagationind, c.title, d.territoryderivedfromcontractind
