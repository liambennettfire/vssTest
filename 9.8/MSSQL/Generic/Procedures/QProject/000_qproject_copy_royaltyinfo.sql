...
BEGIN
  ...
  BEGIN
    ...
    BEGIN
      ...
      DECLARE royaltyformat_cur CURSOR FOR
        SELECT mediacode, formatcode, royaltykey, saleschannelcode, pricetypeforroyalty, note
        FROM taqprojectroyalty
        WHERE taqprojectkey = @i_from_projectkey
      ...
      FETCH NEXT FROM royaltyformat_cur 
      INTO @v_mediatype, @v_mediasubtype, @v_royaltykey, @v_saleschannelcode, @v_pricetypeforroyalty, @v_note
      ...
      BEGIN
        ...
        INSERT INTO taqprojectroyalty
          (royaltykey, taqprojectkey, mediacode, formatcode, saleschannelcode, pricetypeforroyalty, lastuserid, lastmaintdate, note)
        VALUES
          (@v_newroyaltykey, @i_new_projectkey, @v_mediatype, @v_mediasubtype, @v_saleschannelcode, @v_pricetypeforroyalty, @i_userid, getdate(), @v_note)
