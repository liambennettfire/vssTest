...
**    05/12/2015	  Colman             Unnecessary implicit join to gentablesitemtype was causing problems
*******************************************************************************/
  ...
  SELECT DISTINCT g.tabledesclong, s.*,
         ...
         o.orgentrykey,
         p.searchitemcode as itemtypecode, p.usageclasscode as itemtypesubcode  
