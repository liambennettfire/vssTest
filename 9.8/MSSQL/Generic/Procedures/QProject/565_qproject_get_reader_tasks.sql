...
*******************************************************************************/
  ...
  SET @SearchSQL = N'select t.taqtaskkey, t.taqprojectkey, t.bookkey, t.printingkey, cr.taqprojectcontactrolekey,
					...
					pc.globalcontactkey, t.rolecode, d.triggerdateind, t.activedate as origactivedate, cp.projecttitle projectname,ct.title  
