/******************************************************************************
**  Name: imp_300012005001
**  Desc: IKE Add/Replace Format by code (datadescshort)
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_300012005001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_300012005001]
GO

CREATE PROCEDURE dbo.imp_300012005001 
...
/* Add/Replace Format by code (datadescshort) */
...
GRANT EXECUTE ON dbo.[imp_300012005001] to PUBLIC 
GO
