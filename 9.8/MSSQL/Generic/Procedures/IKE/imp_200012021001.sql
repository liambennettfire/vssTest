/******************************************************************************
**  Name: imp_200012021001
**  Desc: IKE Check for Valid Actual Season Description
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_200012021001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_200012021001]
GO

CREATE PROCEDURE dbo.imp_200012021001 
...
/* Check for Valid Actual Season Description */

BEGIN 

/*  SEASON DESCRIPTION VALIDATION	*/
SET NOCOUNT ON
...
GRANT EXECUTE ON dbo.[imp_200012021001] to PUBLIC 
GO
