/******************************************************************************
**  Name: imp_200000000001
**  Desc: IKE Field Exists Errors
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_200000000001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_200000000001]
GO

CREATE PROCEDURE dbo.imp_200000000001 
...
BEGIN
	...
	ELSE
		BEGIN
			SET @v_msg = 'FATAL ERROR:'+@v_elementdesc+' is missing'
			SET @v_errlevel = 3
		END
...
GRANT EXECUTE ON dbo.[imp_200000000001] to PUBLIC 
GO
