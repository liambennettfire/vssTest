if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc018') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc018
GO

if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_ver_net_sales') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_ver_net_sales
GO

CREATE PROCEDURE qpl_calc_ver_net_sales (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,  
...
/******************************************************************************************
**  Name: qpl_calc_ver_net_sales
**  Desc: Island Press Item 18 - Version/Net Sales $.
**
**  Auth: Kate
...
GRANT EXEC ON qpl_calc_ver_net_sales TO PUBLIC
GO
