    ...
    IF @v_lockedind = 0 BEGIN
      ...
      BEGIN
        ...
        DECLARE compqtycosts_cur CURSOR FOR
          SELECT c.taqversionformatyearkey, c.printingnumber, c.acctgcode, c.taqversionspeccategorykey, c.plcalccostcode, c.versioncostsamount, c.compunitcost, @v_compqty
