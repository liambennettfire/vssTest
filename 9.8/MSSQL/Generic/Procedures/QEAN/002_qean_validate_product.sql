...
--        IF @v_ean_prefix = '979'
  ...
  EXEC qean_get_element_group @v_ean_prefix, @v_work_string, @v_group_element OUTPUT, 
  ...
  EXEC qean_get_element_pubprefix @v_ean_prefix, @v_work_string, @v_group_length, @v_pubprefix_element OUTPUT,
    @o_error_code OUTPUT, @o_error_desc OUTPUT
