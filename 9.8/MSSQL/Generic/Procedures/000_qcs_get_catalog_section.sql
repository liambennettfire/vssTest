...
BEGIN
  ...
  SELECT rv.taqprojectrelationshipkey,rv.relatedprojectkey,'BROWSE' typetag,0 summarymode,rv.relatedprojectname as "name",
         ...
         (select eloquencefieldtag from alan..gentables where tableid = 647 and datacode = r.datacode1) displaytypetag,
         (select eloquencefieldtag from alan..gentables where tableid = 648 and datacode = r.datacode2) ordertypetag,
