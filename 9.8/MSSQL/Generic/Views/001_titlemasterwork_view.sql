...
select 
 ...
 WHERE b.workkey = tp.workkey
   ...
   AND pv1.projectsearchitemcode = (select datacode FROM subgentables WHERE tableid = 550 AND qsicode = 28) --  Work
   AND pv1.projectusageclasscode = (select datasubcode FROM subgentables WHERE tableid = 550 AND qsicode = 53) -- Master Work
...
select 
 ...
 WHERE b.workkey = tp.workkey
   AND tp.searchitemcode = (select datacode FROM gentables WHERE tableid = 550 AND qsicode = 9) -- Work
   AND tp.usageclasscode = (select datasubcode FROM subgentables WHERE tableid = 550 AND qsicode = 28) -- Work
   AND tp.taqprojectkey NOT IN (SELECT relatedprojectkey FROM projectrelationshipview  WHERE projectrelationshipview.projectsearchitemcode = (select datacode FROM subgentables WHERE tableid = 550 AND qsicode = 28) --  Work
   AND projectrelationshipview.projectusageclasscode = (select datasubcode FROM subgentables WHERE tableid = 550 AND qsicode = 53) -- Master Work
