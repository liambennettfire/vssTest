-- Add Exchange Rate field to Project Detail sections
DECLARE
  @v_datacode INT,
  @v_datasubcode INT,
...
VALUES
  (12, 22, 3, @v_sortorder, 'Exchange Rate', 'ExchRate', 'Exchange Rate')
  
-- Other Project Details
INSERT INTO @InsertTable
  (datacode, datasubcode, numericdesc1, sortorder, datadesc, datadescshort, alternatedesc1)
VALUES
  (13, 25, 2, @v_sortorder, 'Exchange Rate', 'ExchRate', 'Exchange Rate')
