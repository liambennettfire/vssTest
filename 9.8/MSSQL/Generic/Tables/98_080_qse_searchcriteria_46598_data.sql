-- This is identical to 98_080_qse_searchcriteria_46621_data.sql but an early version of that was
-- release to certain customers so we need a second version that checks for the old and deletes it
-- and installs the new if the old exists. It does nothing if the old version is not installed.
...
BEGIN
  ...
  VALUES
    (327, 'Customer/Partner/Asset Type', 12, 1, NULL, 0, 0, 
    0, 0, 1, 0, 0, 0)
