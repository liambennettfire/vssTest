-- Add Input AND Approval Currency fields to Project Detail sections
DECLARE
  @v_datacode INT,
  @v_datasubcode INT,
...
VALUES
  (12, 20, 3, @v_sortorder, 'Input Currency', 'InputCurrency', 'Input Currency')
  
INSERT INTO @InsertTable
  (datacode, datasubcode, numericdesc1, sortorder, datadesc, datadescshort, alternatedesc1)
VALUES
  (12, 21, 4, @v_sortorder, 'Approval Currency', 'ApprovalCurrency', 'Approval Currency')
  
-- Other Project Details
INSERT INTO @InsertTable
  (datacode, datasubcode, numericdesc1, sortorder, datadesc, datadescshort, alternatedesc1)
VALUES
  (13, 23, 2, @v_sortorder, 'Currency', 'Currency', 'Currency')
  
INSERT INTO @InsertTable
  (datacode, datasubcode, numericdesc1, sortorder, datadesc, datadescshort, alternatedesc1)
VALUES
  (13, 24, 2, @v_sortorder, 'Approval Currency', 'ApprovalCurrency', 'Approval Currency')
