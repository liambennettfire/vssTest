...
Jason donovan 
11-15-2016 
Modified the function call of dbo.proper_case to dbo.rpt_proper_case 
as the function proper_case does not exist
*/
...
BEGIN
	...
	IF @v_column = 'D'
		BEGIN
			SELECT @v_desc = LTRIM(RTRIM(dbo.rpt_proper_case(g.datadesc)))+'/'+LTRIM(RTRIM(s.datadesc))
