/******************************************************************************
**  Name: qproject_get_task_selectlist_printing
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].qproject_get_task_selectlist_printing') and xtype in (N'FN', N'IF', N'TF'))
drop function [dbo].qproject_get_task_selectlist_printing
GO
...
CREATE FUNCTION qproject_get_task_selectlist_printing(
