if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qproject_get_misc_checkbox_value') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qproject_get_misc_checkbox_value
GO

CREATE FUNCTION dbo.qproject_get_misc_checkbox_value
(
...
/*******************************************************************************************************
**  Name: qproject_get_misc_checkbox_value
...
GRANT EXEC ON dbo.qproject_get_misc_checkbox_value TO public
GO
