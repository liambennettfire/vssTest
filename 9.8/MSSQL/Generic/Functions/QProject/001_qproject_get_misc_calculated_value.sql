if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qproject_get_misc_calculated_value') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qproject_get_misc_calculated_value
GO

CREATE FUNCTION dbo.qproject_get_misc_calculated_value
(
...
/*******************************************************************************************************
**  Name: qproject_get_misc_calculated_value
**  Desc: This function returns the miscellaneous calculated value for specific Project as a varchar.
**
**  Auth: Uday A. Khisty
**  Date: April 10 2015
*******************************************************************************************************/
...
GRANT EXEC ON dbo.qproject_get_misc_calculated_value TO public
GO
