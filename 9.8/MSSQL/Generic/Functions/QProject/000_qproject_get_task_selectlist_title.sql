/******************************************************************************
**  Name: qproject_get_task_selectlist_title
...
BEGIN
  ...
  IF (@i_related_projects > 0) BEGIN
    ...
    SELECT t.taqprojectkey, 0, 0, 0, c.searchitemcode, c.usageclasscode, c.projecttitle, c.usageclasscodedesc, c.projectstatus
  ...
  IF (@i_related_contracts > 0) BEGIN
    INSERT INTO @selectionlist (projectkey,contactkey,bookkey,printingkey,itemtypecode,usageclasscode,itemdesc,usageclassdesc, projectstatus)
    SELECT t.contractprojectkey, 0, 0, 0, c.searchitemcode, c.usageclasscode, c.projecttitle, c.usageclasscodedesc, c.projectstatus
