IF exists (select * from dbo.sysobjects where id = object_id(N'dbo.qproject_get_maxprintingnum') )
DROP FUNCTION dbo.qproject_get_maxprintingnum
GO
...
CREATE FUNCTION [dbo].[qproject_get_maxprintingnum]
(
...
/*****************************************************************************************************************************************************
**  Name: [qproject_get_maxprintingnum]
**  Desc: This function returns the maximum printingnum based on the maximum printing number for the input Project (Work, Purchase Order , Printing).
**
**  Auth: Uday A. Khisty
**  Date: March 6, 2015
*******************************************************************************************************************************************************
...
BEGIN 
  ...
  END
  ELSE BEGIN
	  SELECT @v_max_printingnum = MAX(printingnum) FROM printing WHERE bookkey = @v_bookkey 
  END
...
GRANT EXEC ON qproject_get_maxprintingnum TO PUBLIC
go
