if exists (select * from dbo.sysobjects where id = object_id(N'dbo.get_estmessage_errorseverity') and xtype in (N'FN', N'IF', N'TF'))
drop function dbo.get_estmessage_errorseverity
GO

CREATE FUNCTION get_estmessage_errorseverity
...
/******************************************************************************
**  File: 
**  Name: get_estmessage_errorseverity
...
GRANT EXEC ON dbo.get_estmessage_errorseverity TO public
GO
