if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_misc_value') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qtitle_get_misc_value
GO

CREATE FUNCTION dbo.qtitle_get_misc_value
(
...
GRANT EXEC ON dbo.qtitle_get_misc_value TO public
GO
