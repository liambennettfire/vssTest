if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_misc_value_info') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qtitle_get_misc_value_info
GO

CREATE FUNCTION dbo.qtitle_get_misc_value_info
(
...
/******************************************************************************
**  Name: qtitle_get_misc_value_info
...
GRANT EXEC ON dbo.qtitle_get_misc_value_info TO public
GO
