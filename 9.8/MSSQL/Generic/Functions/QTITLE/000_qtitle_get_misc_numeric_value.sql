if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_misc_numeric_value') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qtitle_get_misc_numeric_value
GO

CREATE FUNCTION dbo.qtitle_get_misc_numeric_value
(
...
/*******************************************************************************************************
**  Name: qtitle_get_misc_numeric_value
**  Desc: This function returns the miscellaneous numeric value for specific Title as a varchar.
**
**  Auth: Uday A. Khisty
**  Date: April 10 2015
*******************************************************************************************************/
...
BEGIN 
  ...
  IF EXISTS (SELECT * FROM bookmisc WHERE bookkey = @i_bookkey AND misckey = @i_misckey) BEGIN   
	  ...
	  IF @v_misctype = 1  --Calculated - Integer
...
GRANT EXEC ON dbo.qtitle_get_misc_numeric_value TO public
GO
