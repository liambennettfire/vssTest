select t.bookkey, t.printingkey, t.lastuserid, t.columnkey, 
 ...
 from titlehistory t, coretitleinfo c, bookbisaccategory b, bookbisaccategory_bkup_bisac2013 o, gentables g, subgentables sg, gentables g2, subgentables sg2
where t.lastuserid = 'FB_BISACSUBJECT_UPDATE_2013'
  and t.bookkey = c.bookkey and t.printingkey = c.printingkey
  and t.bookkey = b.bookkey and t.printingkey = b.printingkey
  and b.lastuserid = 'FB_BISACSUBJECT_UPDATE_2013'
