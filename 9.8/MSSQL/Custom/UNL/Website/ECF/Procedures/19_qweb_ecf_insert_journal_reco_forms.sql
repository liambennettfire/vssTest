...
create procedure qweb_ecf_insert_journal_reco_forms (@i_bookkey int,@v_filepath varchar(255)) as
...
BEGIN
	...
	and p.code in (Select bookkey from UNL..bookdetail where publishtowebind = 1)
