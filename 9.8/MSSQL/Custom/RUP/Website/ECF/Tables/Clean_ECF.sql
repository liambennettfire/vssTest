...
GO
DBCC CHECKIDENT ("dbo.category", RESEED, 151);
GO

-- Here I need to manually create the Home and Titles and Subject piece.
INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Home',1,1,0,118,0,218,getdate(), getdate(), 1, 'CAT234343','.152.')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Titles',1,1,152,113,0,217,getdate(), getdate(), 1, 'CAT234344','.152.153.')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Subjects',1,1,153,113,0,216,getdate(), getdate(), 1, 'CAT234345','.152.153.154')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Web Feature',1,1,153,113,0,217,getdate(), getdate(), 1, 'CAT234345','.152.153.155')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Series',1,1,153,113,0,217,getdate(), getdate(), 1, 'CAT234345','.152.153.156')

--INSERT INTO Category
--([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
--VALUES     
--('Content',1,1,152,113,0,218,getdate(), getdate(), 1, 'CAT234345','.152.153.157')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Authors',1,1,152,121,0,225,getdate(), getdate(), 1, 'CAT234345','.152.153.157')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Author Web Feature',1,1,157,113,0,217,getdate(), getdate(), 1, 'CAT234345','.152.153.158')

INSERT INTO Category
([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
VALUES     
('Featured Author',1,1,158,113,0,217,getdate(), getdate(), 1, 'CAT234345','.152.153.159')

--INSERT INTO Category
--([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
--VALUES     
--('Home Page Feature',1,1,153,113,0,217,getdate(), getdate(), 1, 'CAT234345','.152.153.159')

--INSERT INTO Category
--([Name],[Ordering],[IsVisible],[ParentCategoryId],[CategoryTemplateId],[TypeId],[MetaClassId],[Updated],[Created],[IsInherited],[Code],[Path])
--VALUES     
--('Home Page Web Feature',1,1,153,113,0,217,getdate(), getdate(), 1, 'CAT234345','.152.153.159')
...
truncate table CategoryEx_Title_Series
truncate table CategoryEx_Title_Series_history
