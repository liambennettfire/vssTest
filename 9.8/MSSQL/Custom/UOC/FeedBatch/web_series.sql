...
Print 'Executing Web Series Out Stored Proc'
go
...
example  execute webseriesout_sp '01/01/2004' */
...
execute webseriesout_sp  @d_cutoffdate,'c:\','qsidba','qsidba'
GO
