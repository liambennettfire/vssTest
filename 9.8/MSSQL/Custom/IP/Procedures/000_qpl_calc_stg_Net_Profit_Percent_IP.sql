IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[qpl_calc_stg_Net_Profit_Percent_IP]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[qpl_calc_stg_Net_Profit_Percent_IP]
GO



Create PROCEDURE qpl_calc_stg_Net_Profit_Percent_IP (  
...
**  Name: qpl_calc_stg_Net_Profit_Percent_IP
...
Go
Grant all on qpl_calc_stg_Net_Profit_Percent_IP to public