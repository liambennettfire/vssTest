...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[qpl_Calc_stg_COGS_IP]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[qpl_Calc_stg_COGS_IP]
GO
...
CREATE PROCEDURE [dbo].[qpl_Calc_stg_COGS_IP] (  
  @i_projectkey INT,
  @i_plstage    INT,
...
GRANT ALL ON qpl_Calc_stg_COGS_IP TO PUBLIC
