if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_yr_gross_marg_pct_UCAL') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_yr_gross_marg_pct_UCAL
GO  

CREATE PROCEDURE dbo.qpl_calc_yr_gross_marg_pct_UCAL (    
  @i_projectkey INT,  
  @i_plstage    INT,  
  @i_plversion  INT, 
  @i_yearcode   INT, 
...
END  
GO
GRANT EXECUTE ON dbo.qpl_calc_yr_gross_marg_pct_UCAL TO PUBLIC