...
If @v_importtype = 'F' --Full Import
	...
	-- Add Categories for Program
	exec qweb_ecf_Category_Insert_Program_Category
	print 'qweb_ecf_Category_Insert_Program_Category'
...
--		print 'qweb_ecf_Categorization_Insert_Program_Category Begin - BookKey:' print @i_bookkey
		exec qweb_ecf_Categorization_Insert_Program_Category @i_bookkey
--		print 'qweb_ecf_Categorization_Insert_Program_Category COMPLETE - BookKey:' print @i_bookkey
