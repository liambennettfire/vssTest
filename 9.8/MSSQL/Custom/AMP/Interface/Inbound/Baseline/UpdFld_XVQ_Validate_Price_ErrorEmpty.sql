...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_Price_ErrorEmpty') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_Price_ErrorEmpty
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_Price_ErrorEmpty
@bookkey        int,
@pricecode      int,
@currencycode   int,
