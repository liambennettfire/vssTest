...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_Table_Number_IgnoreEmpty') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_Table_Number_IgnoreEmpty
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_Table_Number_IgnoreEmpty
@bookkey        int,
...
if len(ltrim(@fld_buffer)) = 0 begin
