...
IF OBJECT_ID('dbo.UpdFld_XVQ_Validate_Price_IgnoreEmpty') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Validate_Price_IgnoreEmpty
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Validate_Price_IgnoreEmpty
@bookkey        int,
@pricecode      int,
@currencycode   int,
