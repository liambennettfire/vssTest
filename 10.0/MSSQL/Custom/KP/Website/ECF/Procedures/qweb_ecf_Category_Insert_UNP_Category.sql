if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[qweb_ecf_Category_Insert_UNP_Category]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
...
BEGIN
	...
	Select @MaxSort = Max(sortorder) from  cbd..gentables
...
GO
Grant execute on dbo.qweb_ecf_Category_Insert_UNP_Category to Public
GO