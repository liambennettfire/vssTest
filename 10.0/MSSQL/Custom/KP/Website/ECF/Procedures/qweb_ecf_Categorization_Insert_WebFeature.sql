...
BEGIN
	...
	where categorytableid = 413
		/*and bookkey in (Select bookkey from cbd..bookdetail where publishtowebind =1)*/
	 ...
	 while (@i_webfeature_fetchstatus >-1 )
		...
		begin
			...
			Select @subject_object_id = objectid 
				...
				and pss_webfeature_categorytableid = 413
...
GO
Grant execute on dbo.qweb_ecf_Categorization_Insert_WebFeature to Public
GO