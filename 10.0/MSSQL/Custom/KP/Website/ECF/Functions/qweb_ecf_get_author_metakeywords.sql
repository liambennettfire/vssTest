...
DECLARE @v_metakeywords varchar(512),
	...
	Select @v_metakeywords = cbd.dbo.qweb_get_Title(@i_workkey,'F') + ', '
	...
	select  @i_titlefetchstatus  = @@FETCH_STATUS
	 ...
	 while (@i_titlefetchstatus >-1 )
		...
		cbd.dbo.qweb_get_Isbn(@i_bookkey,10) + ', ' +
		cbd.dbo.qweb_get_Isbn(@i_bookkey,13) + ', ' +
		cbd.dbo.qweb_get_Isbn(@i_bookkey,16) + ', ' +
		cbd.dbo.qweb_get_Isbn(@i_bookkey,17) + ', ' 
