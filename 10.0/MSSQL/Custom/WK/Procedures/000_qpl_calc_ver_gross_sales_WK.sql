if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_ver_gross_sales_WK') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_ver_gross_sales_WK
GO

CREATE PROCEDURE qpl_calc_ver_gross_sales_WK (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
...
/******************************************************************************************
**  Name: qpl_calc_ver_gross_sales_WK
...
GRANT EXEC ON dbo.qpl_calc_ver_gross_sales_WK TO PUBLIC
GO
