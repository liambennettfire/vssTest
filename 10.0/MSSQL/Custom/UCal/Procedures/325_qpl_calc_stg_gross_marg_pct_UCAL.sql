if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_stg_gross_marg_pct_UCAL') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_stg_gross_marg_pct_UCAL
GO  

CREATE PROCEDURE dbo.qpl_calc_stg_gross_marg_pct_UCAL (    
  @i_projectkey INT,  
  @i_plstage    INT,  
...
BEGIN  
  ...
  EXEC qpl_calc_stg_gross_marg_UCAL @i_projectkey, @i_plstage,  @v_gross_margin OUTPUT  
...
END  
GO
GRANT EXECUTE ON dbo.qpl_calc_stg_gross_marg_pct_UCAL TO PUBLIC