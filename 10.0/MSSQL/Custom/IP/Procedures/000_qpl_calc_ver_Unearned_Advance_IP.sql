IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[qpl_calc_ver_Unearned_Advance_IP]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[qpl_calc_ver_Unearned_Advance_IP]
GO



CREATE PROCEDURE qpl_calc_ver_Unearned_Advance_IP (  
...
**  Name: qpl_calc_ver_Unearned_Advance_IP
...
Go
Grant all on qpl_calc_ver_Unearned_Advance_IP to public