IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[qpl_calc_ver_gross_marg_pct_IP]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[qpl_calc_ver_gross_marg_pct_IP]
GO



CREATE PROCEDURE qpl_calc_ver_gross_marg_pct_IP (  
...
**  Name: qpl_calc_ver_gross_marg_pct_IP
...
END
Go
Grant all on qpl_calc_ver_gross_marg_pct_IP to public