...
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[qpl_Calc_ver_Royalty_Write_Off_IP]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[qpl_Calc_ver_Royalty_Write_Off_IP]
GO

CREATE PROCEDURE [dbo].[qpl_Calc_ver_Royalty_Write_Off_IP] (  
...
Go
Grant all on qpl_Calc_ver_Royalty_Write_Off_IP to Public