if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[CATREVIEWS_VIEW]') and OBJECTPROPERTY(id, N'IsView') = 1)
  drop view [dbo].[CATREVIEWS_VIEW]
GO
create view dbo.CATREVIEWS_VIEW(BOOKKEY, SUBJECTKEY, CATEGORYCODE, CATEGORYDESC, CATEGORYSUBCODE, CATEGORYSUBDESC, SORTORDER, LASTUSERID, LASTMAINTDATE)  AS 
  ...
  *****/
  ...
  SELECT TOP 100 PERCENT 
    ...
    WHERE ((bs.CATEGORYTABLEID = 414) AND 
...
go
GRANT SELECT ON CATREVIEWS_VIEW TO public
go