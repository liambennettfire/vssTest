if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_yr_tot_inc_RUP') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_yr_tot_inc_RUP
GO

CREATE PROCEDURE qpl_calc_yr_tot_inc_RUP (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
  @i_yearcode   INT,
...
/******************************************************************************************
**  Name: qpl_calc_yr_tot_inc_RUP
**  Desc: P&L - Year/TOTAL Income for Rutgers.  Removed Subsidiary Rights Income 
...
GRANT EXEC ON qpl_calc_yr_tot_inc_RUP TO PUBLIC
GO
