...
SELECT @v_usageclass_marketing = datasubcode FROM subgentables WHERE tableid = 550 and qsicode = 9
SELECT @v_usageclass_publicity = datasubcode FROM subgentables WHERE tableid = 550 and qsicode = 54
