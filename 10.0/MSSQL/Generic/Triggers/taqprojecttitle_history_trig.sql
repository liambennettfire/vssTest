IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'taqprojecttitle_history')
	BEGIN
		DROP  Trigger dbo.taqprojecttitle_history
	END
GO

CREATE TRIGGER [dbo].taqprojecttitle_history ON [dbo].taqprojecttitle
