...
**    --------    --------     -------   --------------------------------------
**    03/17/17    Uday         43529
**    12/13/17    Colman       48339     Implemented availsecurityobjectkey.firstprintingind support
*******************************************************************************************************/
...
BEGIN 
  ...
  WHILE @@fetch_status = 0 BEGIN                   
    ...
    SELECT @object_accessind_var = accessind   
      ...
      WHERE o.availsecurityobjectkey = a.availablesecurityobjectskey AND  
            ...
            AND (@i_key2 = 1 OR ISNULL(o.firstprintingind, 'N') = 'N')
  ...
  IF @v_at_least_one_status_setup = 0 
  BEGIN
