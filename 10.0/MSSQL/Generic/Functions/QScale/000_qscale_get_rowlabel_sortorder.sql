if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qscale_get_rowlabel_sortorder') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qscale_get_rowlabel_sortorder
GO

CREATE FUNCTION qscale_get_rowlabel_sortorder
...
/******************************************************************************
**  File: qscale_get_rowlabel_sortorder
**  Name: qscale_get_rowlabel_sortorder
**  Desc: This returns the sortorder for the rowlabel for scale grid row. 
**
**
**    Auth: Alan Katzen
...
GRANT EXEC ON dbo.qscale_get_rowlabel_sortorder TO public
GO
