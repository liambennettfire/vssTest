if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_misc_float_value') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.qtitle_get_misc_float_value
GO

CREATE FUNCTION dbo.qtitle_get_misc_float_value
(
...
/*******************************************************************************************************
**  Name: qtitle_get_misc_float_value
**  Desc: This function returns the miscellaneous float value for specific Title as a varchar.
**
**  Auth: Uday A. Khisty
**  Date: April 10 2015
*******************************************************************************************************/
...
GRANT EXEC ON dbo.qtitle_get_misc_float_value TO public
GO
