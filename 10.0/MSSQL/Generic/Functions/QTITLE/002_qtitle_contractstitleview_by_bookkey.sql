...
/*********************************************************************************************************************
**  Name: qtitle_contractstitleview_by_bookkey
**  Desc: This functional table returns contract and title info based on a bookkey
**
**  Auth: Alan Katzen
**  Date: April 23 2018
**
...
BEGIN
  DECLARE 
    ...
    DECLARE @titlemasterworkviewinfo TABLE (
      ...
      titleworksearchitemcode int null,
      titleworkusageclasscode int null) 

    INSERT INTO @titlemasterworkviewinfo
    SELECT bookkey, workprojectkey, masterworkprojectkey, titleworksearchitemcode, titleworkusageclasscode
    ...
    FROM taqproject tp 
        JOIN projectrelationshipview pv ON tp.taqprojectkey = pv.taqprojectkey
        JOIN @titlemasterworkviewinfo tmw ON pv.relatedprojectkey = tmw.Masterworkprojectkey
