...
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.rpt_proper_case') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.rpt_proper_case
GO


create FUNCTION [dbo].[rpt_proper_case]
...
go
grant execute on rpt_proper_case to public
go