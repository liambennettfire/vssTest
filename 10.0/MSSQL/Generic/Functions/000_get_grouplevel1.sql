/****** Object:  UserDefinedFunction [dbo].[get_GroupLevel1]    Script Date: 12/18/2008 14:21:13 ******/
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.get_GroupLevel1') and xtype in (N'FN', N'IF', N'TF'))
drop function dbo.get_GroupLevel1
GO

/****** Object:  UserDefinedFunction [dbo].[get_GroupLevel1]    Script Date: 12/18/2008 14:21:31 ******/
SET ANSI_NULLS ON
GO
...
CREATE FUNCTION [dbo].[get_GroupLevel1]
		(@i_bookkey	INT,
		@v_column	VARCHAR(1))
