...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[season_view]') and OBJECTPROPERTY(id, N'IsView') = 1)
drop view [dbo].[season_view]
GO
...
GRANT  SELECT ,  UPDATE ,  INSERT ,  DELETE  ON [dbo].[season_view]  TO [public]
GO
