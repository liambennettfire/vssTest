...
**  --------    -------   --------------------------------------
**	03/30/17    Colman    41064 - Pass in type/class rather than get from project key so it can be used from AddNewProject
**  06/21/18    Colman    51661
*****************************************************************************************************/
...
BEGIN
  ...
  SELECT @v_itemtype = @i_itemtype, @v_usageclass = @i_usageclass
