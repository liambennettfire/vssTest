...
IF ( @v_pricetypecode4 > 0 AND @v_price4label IS NULL ) 
  ...
  SELECT cu.contentunitkey otherprojectkey, 
    ...
    cu.quantity1, cu.quantity2,
    cu.indicator1, cu.indicator2, 
    ...
    dbo.qproject_get_misc_sortvalue( cu.contentunitkey, @v_miscitemkey1 ) miscItem1sortvalue, 
    ...
    dbo.qproject_get_misc_sortvalue( cu.contentunitkey, @v_miscitemkey2 ) miscItem2sortvalue, 
    ...
    dbo.qproject_get_misc_sortvalue( cu.contentunitkey, @v_miscitemkey3 ) miscItem3sortvalue, 
    ...
    dbo.qproject_get_misc_sortvalue( cu.contentunitkey, @v_miscitemkey4 ) miscItem4sortvalue, 
    ...
    dbo.qproject_get_misc_sortvalue( cu.contentunitkey, @v_miscitemkey5 ) miscItem5sortvalue, 
    ...
    dbo.qproject_get_misc_sortvalue( cu.contentunitkey, @v_miscitemkey6 ) miscItem6sortvalue, 
