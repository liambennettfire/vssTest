...
BEGIN
  ...
  SET @v_cleardata = dbo.find_integer_in_comma_delim_list(@i_cleardatagroups_list,22)  --Royalty Advances (22)
...
/* 5/8/12 - KW - From case 17842:
  ...
  EXEC qproject_copy_paymentinfo @i_copy_projectkey, @i_new_projectkey, @v_approved_status, @i_userid, @v_cleardata, @o_error_code OUTPUT, @o_error_desc OUTPUT
  ...
  BEGIN
    ...
    IF @v_count = 0
      EXEC qproject_copy_paymentinfo @i_copy2_projectkey, @i_new_projectkey, @v_approved_status, @i_userid, @v_cleardata, @o_error_code OUTPUT, @o_error_desc OUTPUT
  END  
