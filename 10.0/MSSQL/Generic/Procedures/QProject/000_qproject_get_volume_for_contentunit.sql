...
*******************************************************************************/
  ...
  -- get related volumekey
  SELECT @v_volume_datacode = COALESCE(datacode,0)
    FROM gentables
   WHERE tableid = 582
     AND qsicode = 2

  SELECT @v_volumekey = relatedprojectkey, @v_quantity1 = quantity1, @v_quantity2 = quantity2, @v_quantity3 = quantity3, @v_quantity4 = quantity4, 
         @v_indicator1 = indicator1, @v_indicator2 = indicator2, 
