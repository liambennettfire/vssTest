if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qproject_get_relationships_exhibit') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qproject_get_relationships_exhibit
GO
...
CREATE PROCEDURE qproject_get_relationships_exhibit
...
/******************************************************************************
**  Name: qproject_get_relationships_exhibit
...
IF ( @v_pricetypecode4 > 0 AND @v_price4label IS NULL ) 
  ...
  SELECT 1 projectnumber,
   ...
   WHERE r.taqprojectkey1 = @i_projectkey 
     AND relationshipcode1 = 8 AND relationshipcode2 = 9 
...
UNION
  SELECT 2 projectnumber, 
   ...
   WHERE r.taqprojectkey1 = c.projectkey
     ...
     AND relationshipcode2 = 8 AND relationshipcode1 = 9 
...
GRANT EXEC ON qproject_get_relationships_exhibit TO PUBLIC
GO