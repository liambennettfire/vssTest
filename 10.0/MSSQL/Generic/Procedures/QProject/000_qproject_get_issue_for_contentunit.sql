...
*******************************************************************************/
  ...
  -- get related issuekey
  SELECT @v_issue_datacode = COALESCE(datacode,0)
    FROM gentables
    WHERE tableid = 582
      AND qsicode = 3

  SELECT @v_issuekey = relatedprojectkey, @v_quantity1 = quantity1, @v_quantity2 = quantity2, @v_quantity3 = quantity3, @v_quantity4 = quantity4, 
    @v_indicator1 = indicator1, @v_indicator2 = indicator2, @v_taqprojectrelationshipkey = taqprojectrelationshipkey
...
IF ( @v_pricetypecode4 > 0 AND @v_price4label IS NULL ) 
  ...
  SELECT projecttitle as issuename, COALESCE(@v_issuekey,0) issuekey, 
		 ...
		 dbo.qproject_get_misc_sortvalue( @v_issuekey, @v_miscitemkey1 ) miscItem1sortvalue,
		 ...
		 dbo.qproject_get_misc_sortvalue( @v_issuekey, @v_miscitemkey2 ) miscItem2sortvalue,
		 ...
		 dbo.qproject_get_misc_sortvalue( @v_issuekey, @v_miscitemkey3 ) miscItem3sortvalue,
		 ...
		 dbo.qproject_get_misc_sortvalue( @v_issuekey, @v_miscitemkey4 ) miscItem4sortvalue,
		 ...
		 dbo.qproject_get_misc_sortvalue( @v_issuekey, @v_miscitemkey5 ) miscItem5sortvalue,
		 ...
		 dbo.qproject_get_misc_sortvalue( @v_issuekey, @v_miscitemkey6 ) miscItem6sortvalue,
