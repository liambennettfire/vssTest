...
**    --------     --------    --------------------------------------------------------------------------------------
**    03/03/17     Colman      Case 42869 Update Contract Rights and Territory copy project data group
**    03/29/17     Uday        Case 44140 (Fix for change needed by 44117)
*****************************************************************************************************************************/
...
BEGIN
  ...
  BEGIN
    EXEC qproject_copy_rightsinfo @i_copy_projectkey, @i_new_projectkey, @i_clearind, @i_userid, @o_error_code OUTPUT, @o_error_desc OUTPUT
  ...
  BEGIN
    ...
    IF @v_count > 0
    BEGIN
      EXEC qproject_copy_rightsinfo @i_copy2_projectkey, @i_new_projectkey, @i_clearind, @i_userid, @o_error_code OUTPUT, @o_error_desc OUTPUT
