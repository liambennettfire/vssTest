...
**  -----     ------    -------------------------------------------
**  06/08/16  Colman    Case 38496 - Error generated when approving taq with copied author sales track
****************************************************************************************/
...
BEGIN
  ...
  DECLARE assotitles_cur CURSOR FOR
    SELECT p.taqprojectformatkey, p.bookkey, p.associationtypecode, COALESCE(p.associationtypesubcode, 0) AS associationtypesubcode, 
