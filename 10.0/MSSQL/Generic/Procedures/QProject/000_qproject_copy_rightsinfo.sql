...
**    02/21/2017   Colman      Case 42869 Update Contract Rights and Territory copy project data group
**    03/30/2017   Colman      Case 44117 Need to add includeproduction to copy project
**    05/09/2017   Colman      Case 44691 Don't copy productionbookkey
**    12/11/2017   Colman      Case 48528 Rename includeproduction column to relatetitleprtg
**    05/25/2018   Colman      Case 51542 Exchange rates not populated when copying from an existing contract 
*****************************************************************************************************************************/
...
DECLARE
  ...
  @v_newworkkey INT,
  @v_productionqty INT,
  @v_printprice DECIMAL(14,4),
  @v_printpriceexchrate DECIMAL(14,4),
  @v_purchaseprice DECIMAL(14,4),
  @v_purchasepriceexchrate DECIMAL(14,4),
	@v_showtotalscurrency INT,
	@v_printcurrency INT,
	@v_purchasecurrency INT,
  @v_relatetitleprtg TINYINT
BEGIN
  ...
  DECLARE rights_cur CURSOR FOR
    SELECT rightskey, rightsdescription, updatedaftercreateind, rightstypecode, rightspermissioncode, 
      ...
      workkey, productionqty, printprice, printpriceexchrate, purchaseprice, purchasepriceexchrate,
			showtotalscurrency, printcurrency, purchasecurrency, relatetitleprtg
  ...
  INTO @v_rightskey, @v_rightsdesc, @v_updatedind, @v_rightstype, @v_rightspermission,
    ...
    @v_workkey, @v_productionqty, @v_printprice, @v_printpriceexchrate, @v_purchaseprice, @v_purchasepriceexchrate,
		@v_showtotalscurrency, @v_printcurrency, @v_purchasecurrency, @v_relatetitleprtg
  ...
  BEGIN
    ...
    BEGIN
      SET @v_workkey = NULL
      SET @v_productionqty = NULL
      SET @v_printprice = NULL
      SET @v_printpriceexchrate = NULL
      SET @v_purchaseprice = NULL
      SET @v_purchasepriceexchrate = NULL
			SET @v_showtotalscurrency = NULL
			SET @v_printcurrency = NULL
			SET @v_purchasecurrency = NULL
    END
    ...
    INSERT INTO taqprojectrights
      ...
      autoformatdescind, formatdesc, rightslanguagetypecode, languagedesc, autolanguagedescind, 
      subrightssalecode, rightsnote, approvalnote, consultationnote, authorsubrightspercent, 
      --productionqty, printprice, purchaseprice,
      printpriceexchrate, purchasepriceexchrate,
			showtotalscurrency, printcurrency, purchasecurrency, relatetitleprtg,
      workkey, lastuserid, lastmaintdate)
    VALUES
      (@v_newrightskey, @i_new_projectkey, @v_rightsdesc, @v_updatedind, @v_rightstype, @v_rightspermission,
      @v_autoformatdescind, @v_formatdesc, @v_rightslanguagetype, @v_languagedesc, @v_autolanguagedescind,
      @v_subrightssalecode, @v_rightsnote, @v_approvalnote, @v_consultationnote, @v_authorpercent,
      --@v_productionqty, @v_printprice, @v_purchaseprice,
      @v_printpriceexchrate, @v_purchasepriceexchrate,
			@v_showtotalscurrency, @v_printcurrency, @v_purchasecurrency, @v_relatetitleprtg,
      @v_workkey, @i_userid, getdate())
