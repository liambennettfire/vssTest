...
BEGIN
  ...
  WHILE @@FETCH_STATUS = 0 BEGIN        
    ...
    BEGIN
      ...
      print '     SELECT relationshiptabcode, sortorder'
      print '     FROM qsiconfigdetailtabs'
      print '     WHERE configdetailkey = ' + cast(@v_tabconfigdetailkey as varchar)
      print ' '
      print '    OPEN tab_cur'
      print '    FETCH NEXT FROM tab_cur INTO @v_relationshiptabcode, @v_sortorder'
      print ' '
      print '    WHILE @@FETCH_STATUS = 0 BEGIN'
      print '      INSERT INTO qsiconfigdetailtabs (configdetailkey, relationshiptabcode, sortorder, lastuserid, lastmaintdate)'
      print '      VALUES (@v_new_configdetailkey, @v_relationshiptabcode, @v_sortorder, ''Firebrand'', getdate())'
      print ' '
      print '      FETCH NEXT FROM tab_cur INTO @v_relationshiptabcode, @v_sortorder'
      print '    END'
      print '    CLOSE tab_cur'
