          ...
          BEGIN
            ...
            BEGIN            
              ...
              BEGIN               
                ...
                BEGIN
                  ...
                  BEGIN
                    ...
                    BEGIN
					  ...
					  SELECT @TemplateFieldTag = gentext1
					  FROM gentables_ext
					  WHERE tableid = 306
				...
				IF LEN(COALESCE(@TemplateFieldTag, '')) > 0
				BEGIN
				  SET @SQLHistoryExec = @SQLHistoryExec + ',' + @TemplateFieldTag
				END
