...
*******************************************************************************/
  ...
  BEGIN   
    ...
    INSERT INTO qse_searchlist 
      ...
      listtypecode, listdesc, defaultind, lastuserid, lastmaintdate, createdbyuserid, usageclasscode)
    VALUES
      (@CurrentListKey, @i_userkey, @i_searchtypecode, @SearchItemCode,
      1, 'Current Working List', 1, @UserID, getdate(), @UserID, @SearchUsageClassCode)
  ...
  BEGIN   
    ...
    INSERT INTO qse_searchlist 
      (listkey, userkey, searchtypecode, searchitemcode, 
      listtypecode, listdesc, lastuserid, lastmaintdate, createdbyuserid, usageclasscode)
    VALUES 
      (@RecentListKey, @i_userkey, @i_searchtypecode, @SearchItemCode,
      @i_listtypecode, @ListDesc, @UserID, getdate(), @UserID, @SearchUsageClassCode)
