...
**  03/03/2017   Colman      Case 43613 gentablesitemtype text1 label override not working 
*******************************************************************************/
...
AS
  ...
  IF @v_usageclass > 0 BEGIN 
	  ...
	  SELECT gi.datacode, gi.datasubcode, s.datadesc, COALESCE(gi.sortorder, s.sortorder) sortorder, gi.relateddatacode, gi.indicator1, gi.text1, 
      COALESCE(gi.numericdesc1, s.numericdesc1) as numericdesc1, COALESCE(NULLIF(gi.text1,''), s.alternatedesc1) as alternatedesc1
