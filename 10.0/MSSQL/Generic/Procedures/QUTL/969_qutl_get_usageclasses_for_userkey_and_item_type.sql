...
*******************************************************************************/
  ...
  IF @i_SkipThis=0
		SELECT 
			...
			gt.datadesc as itemtype, subgt.datadesc as usageclass, subgt.datadesc, subgt.subgen1ind, COALESCE(subgt.numericdesc1, 1) AS numericdesc1
		FROM 
	...
	ELSE
		SELECT subgt.datacode, subgt.datasubcode,
		  subgt.datadesc as usageclass, subgt.datadesc, subgt.subgen1ind, COALESCE(subgt.numericdesc1, 1) AS numericdesc1
