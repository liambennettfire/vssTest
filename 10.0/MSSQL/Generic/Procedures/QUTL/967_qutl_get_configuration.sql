...
--    END 
  ...
  SET @v_sqlselect1 = 'SELECT COALESCE(d.path, o.path) path, 
      ...
      COALESCE(d.sectioncontrolname,o.sectioncontrolname) sectioncontrolname,
      ...
      o.configobjectid, o.miscsectionind, o.configobjectkey, o.configobjecttype,
      COALESCE(o.tabgroupsectionind,0) tabgroupsectionind, o.sectionimage,
      2 configdetailrow '
  ...
  SET @v_sqlselect3 = 'SELECT o.path, o.viewcontrolname, o.editcontrolname,o.sectioncontrolname,
      ...
      COALESCE(w.windowtitle, w.windowtitle) windowtitle,
      COALESCE(w.windowname, w.windowname) windowname,
      o.configobjectid, o.miscsectionind, o.configobjectkey, o.configobjecttype, COALESCE(o.tabgroupsectionind,0) tabgroupsectionind, o.sectionimage,
      0 usageclasscode,
      0 configdetailrow '
