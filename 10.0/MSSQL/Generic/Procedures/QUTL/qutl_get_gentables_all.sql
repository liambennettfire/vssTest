...
*******************************************************************************/
  ...
  COALESCE(g.datadescshort,g.datadesc) shortdesc, COALESCE(g.gen1ind,0) gen1ind, g.*, e.gen3ind
  FROM gentables g 
    LEFT OUTER JOIN gentablesorglevel o ON (g.tableid = o.tableid and g.datacode = o.datacode) 
    JOIN gentablesdesc d ON (g.tableid = d.tableid)
    JOIN gentables_ext e ON (g.tableid = e.tableid and g.datacode = e.datacode)
