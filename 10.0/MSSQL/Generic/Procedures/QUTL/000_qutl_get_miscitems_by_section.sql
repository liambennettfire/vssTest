...
**  ----------  ---------   ----------------------------------------------------------
**  01/08/2018  Colman      Case 48094 - Create capability to generate a list of bookkey from dashboard search/list items
**************************************************************************************/
  ...
  IF @i_usageclasscode > 0 BEGIN 
	  ...
	  SELECT i.misckey, i.miscname, i.misclabel, i.misctype, i.fieldformat, i.datacode, 
		  i.sendtoeloquenceind, i.defaultsendtoeloqvalue, i.taqtotmmind, i.searchurl, i.searchtype,
