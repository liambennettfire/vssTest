IF EXISTS(SELECT * FROM sys.objects WHERE type = 'p' and name = 'qutl_insert_titlerelationshiptabconfig_misc' ) 
     DROP PROCEDURE qutl_insert_titlerelationshiptabconfig_misc 
GO

CREATE PROCEDURE [dbo].[qutl_insert_titlerelationshiptabconfig_misc]
...
/***********************************************************************************************
**  Name: qutl_insert_titlerelationshiptabconfig_misc
...
BEGIN
   ...
   IF @i_tabmisc_order = 1
       UPDATE titlerelationshiptabconfig SET miscitem1label = @i_misctablabel, miscitemkey1 = @v_misckey 
       WHERE @o_titlerelationshipconfigkey = titlerelationshiptabconfigkey
   ELSE IF @i_tabmisc_order = 2
       UPDATE titlerelationshiptabconfig SET miscitem2label = @i_misctablabel, miscitemkey2 = @v_misckey 
       WHERE @o_titlerelationshipconfigkey = titlerelationshiptabconfigkey
   ELSE IF @i_tabmisc_order = 3
       UPDATE titlerelationshiptabconfig SET miscitem3label = @i_misctablabel, miscitemkey3 = @v_misckey 
       WHERE @o_titlerelationshipconfigkey = titlerelationshiptabconfigkey      
   ELSE IF @i_tabmisc_order = 4
       UPDATE titlerelationshiptabconfig SET miscitem4label = @i_misctablabel, miscitemkey4 = @v_misckey 
       WHERE @o_titlerelationshipconfigkey = titlerelationshiptabconfigkey   
    ELSE IF @i_tabmisc_order = 5
       UPDATE titlerelationshiptabconfig SET miscitem5label = @i_misctablabel, miscitemkey5 = @v_misckey 
       WHERE @o_titlerelationshipconfigkey = titlerelationshiptabconfigkey   
    ELSE IF @i_tabmisc_order = 6
       UPDATE titlerelationshiptabconfig SET miscitem6label = @i_misctablabel, miscitemkey6 = @v_misckey 
       WHERE @o_titlerelationshipconfigkey = titlerelationshiptabconfigkey   
...
GRANT EXEC ON qutl_insert_titlerelationshiptabconfig_misc TO PUBLIC
GO