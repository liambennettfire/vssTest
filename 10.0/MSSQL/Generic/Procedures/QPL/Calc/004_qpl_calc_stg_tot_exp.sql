IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'qpl_calc_stg_tot_exp')
  DROP PROCEDURE qpl_calc_stg_tot_exp
GO

CREATE PROCEDURE [dbo].[qpl_calc_stg_tot_exp] (  
  @i_projectkey INT,
  @i_plstage    INT,
