IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'qpl_calc_stg_roy_adv')
  DROP PROCEDURE qpl_calc_stg_roy_adv
GO

CREATE PROCEDURE [dbo].[qpl_calc_stg_roy_adv] (  
  @i_projectkey INT,
  @i_plstage    INT,
...
BEGIN
  ...
  ELSE
    BEGIN
      ...
      EXEC qpl_calc_ver_roy_adv @i_projectkey, @i_plstage, @v_selected_versionkey, @o_result OUTPUT, @i_roleSumItemCode, @i_allIncludedInd
    END
