if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_year') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_year
GO
 
CREATE PROCEDURE qpl_calc_year (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
  @i_yearcode   INT,  
...
GRANT EXEC ON qpl_calc_year TO PUBLIC
GO
