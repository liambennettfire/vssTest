...
BEGIN
  ...
  --exec qutl_trace 'qpl_generate_scale_costs',
  --  '@i_taqversionspecitemkey', @i_taqversionspecitemkey, NULL,
  --  '@i_taqdetailscalekey', @i_taqdetailscalekey, NULL,
  --  '@i_autoapplyind', @i_autoapplyind, NULL,
  --  '@i_percentcalcind', @i_percentcalcind, NULL,
  --  '@i_calcspecqsicode', @i_calcspecqsicode, NULL,
  --  '@i_perqty', @i_perqty, NULL,
  --  '@i_specialprocess', NULL, @i_specialprocess,
