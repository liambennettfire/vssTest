...
*   --------     --------    ----------------------------------------------------------------------------------------------------
**  03/28/2016   Kusum       Case 31327 Barcode is written out to title history every time a spec item is updated
**  07/08/2016   UK          Case 38816 - Task 002
**  11/18/2016   UK          Case 40492
**  07/20/2017   BL          Case 46313
**  11/01/2017   Colman      Case 47014 SS-Clearing page counts does not write back to printing table
*********************************************************************************************************************************/
    ...
    BEGIN --2
      ...
      BEGIN--3
        ...
        */          
        ...
        --EXEC qutl_trace 'qpl_sync_specitems2tables',
        --  '@v_tablename', NULL, @v_tablename,
        --  '@v_column', NULL, @v_column,
        --  '@v_specitemtype', NULL, @v_specitemtype,
        --  '@v_datatype', NULL, @v_datatype
        ...
        BEGIN --9            
            ...
            BEGIN --12
              ...
              --EXEC qutl_trace 'qpl_sync_specitems2tables',
              --  '@v_targetvalue', NULL, @v_targetvalue
            ...
            BEGIN--13
              ...
              IF ISNULL(@v_targetqtyvalue,-1) != -1
              BEGIN
            ...
            BEGIN --14
                ...
                IF ISNULL(@v_targetdetailvalue,-1) != -1
                BEGIN
            ...
            BEGIN --14A
                ...
                IF ISNULL(@v_targetdetail2value,-1) != -1
                BEGIN
                  --check mappings and transform
                  IF coalesce(@i_mappingkey,0)<>0
            ...
            IF coalesce(@v_specitemtype,'')='Q' and coalesce(@v_datatype,'')<>'decimal'
            begin --21
            --compare target to target value, if different, update
              IF @i_targetqtyvalue IS NULL OR coalesce(@i_qtyvalue,-1) <> @i_targetqtyvalue
            ...
            IF coalesce(@v_specitemtype,'')='DT'
            begin --22
            --compare target to target value, if different, update
              IF @i_targetdetailvalue IS NULL OR coalesce(@i_detailvalue,-1) <> @i_targetdetailvalue
            ...
            IF coalesce(@v_specitemtype,'')='T2'
            begin --22
            --compare target to target value, if different, update
              IF @i_targetdetail2value IS NULL OR coalesce(@i_detailvalue,-1) <> @i_targetdetail2value
            ...
            -- UK Case 40492 - removed the change for preventing NULL to be updated for Description 
            IF coalesce(@v_specitemtype,'')='D2'
            begin --24
