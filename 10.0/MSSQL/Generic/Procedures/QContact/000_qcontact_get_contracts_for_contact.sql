...
**  02/22/2018   Colman      49855 - Ensure that globalcontactkey is valid
**  04/12/2018   Colman      50857 - Add contactroledesc return column
*******************************************************************************/
...
BEGIN
  ...
  SET @v_sqlstring = N'SELECT DISTINCT p.projectkey,
    ...
    dbo.qproject_participant_role_summary(p.projectkey, c.taqprojectcontactkey) as contactroledesc
  FROM coreprojectinfo p, taqprojectcontact c, taqprojectorgentry o, globalcontact gc
