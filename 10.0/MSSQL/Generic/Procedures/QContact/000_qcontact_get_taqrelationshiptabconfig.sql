...
BEGIN
  ...
  SELECT quantity1label, quantity2label, quantity3label, quantity4label, indicator1label, indicator2label, 
    miscitemkey1,
    CASE
    ...
    lastmaintdate, lastuserid,COALESCE(alloweditablefieldsind,0) alloweditablefieldsind, scrollbarheight
  FROM taqrelationshiptabconfig
