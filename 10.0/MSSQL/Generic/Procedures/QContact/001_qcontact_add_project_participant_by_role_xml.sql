...
DECLARE 
  ...
  WITH (ProjectKeyAsString VARCHAR(255) 'ProjectKey',
      ...
      GenericText varchar(50) 'GenericText',
...
--  PRINT 'userid=' + @v_UserID 
  ...
  EXEC qcontact_add_project_participant_by_role @v_ProjectKey, @v_GlobalContactKey, @v_KeyInd, @v_AddressKey, @v_ParticipantNote, @v_GenericText,
