...
--        where masterkey = @v_authorkey
      ...
      if @v_corporatecontributorind = 1 begin
        ...
        insert into globalcontact
          (globalcontactkey,displayname,searchname,individualind,privateind,grouptypecode,groupname,firstname,lastname,middlename,uscitizenind,lastuserid,lastmaintdate)
          (select authorkey,displayname,upper(lastname),0,0,0,lastname,firstname,lastname,middlename,uscitizenind,'a2c qsi',getdate()
              from author
        ...
        insert into globalcontact
          (globalcontactkey,displayname,searchname,individualind,privateind,grouptypecode,firstname,lastname,middlename,
			  accreditationcode,suffix,degree,uscitizenind,globalcontactnotes,lastuserid,lastmaintdate,
           externalcode1,externalcode2)
          (select authorkey,displayname,upper(lastname),1,0,0,firstname,lastname,middlename,
                  nameabbrcode,authorsuffix,authordegree,uscitizenind,notes,'a2c qsi',getdate(),
