...
create procedure whviewexec_sp @c_viewname varchar (100), @c_keycolumns varchar (255), @c_sqlstmt varchar (max)
as
begin
...
declare @c_sqlstmtdrop varchar (max)
declare @c_sqlstmtgrant varchar (max)
