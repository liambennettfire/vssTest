if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_update_territorial_history') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qtitle_update_territorial_history
GO
...
CREATE PROCEDURE qtitle_update_territorial_history
...
/************************************************************************************
**  Name: qtitle_update_territorial_history
...
GRANT EXEC ON qtitle_update_territorial_history TO PUBLIC
GO
