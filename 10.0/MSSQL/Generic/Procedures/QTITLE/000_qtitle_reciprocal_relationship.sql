...
*******************************************************************************/
  ...
  DECLARE 
    ...
    @v_volumenumber INT,
    @v_numtitles  INT,
    @v_associationtypedesc VARCHAR(40)
  ...
  BEGIN
    ...
    BEGIN
      ...
      BEGIN
        ...
        SET @v_associationtypedesc = ltrim(rtrim(dbo.get_gentables_desc(440, @v_datacode, 'long')))
        SET @v_fielddesc = ltrim(rtrim(dbo.get_subgentables_desc(440, @v_datacode, @v_datasubcode, 'long')))
        IF @v_fielddesc IS NOT NULL BEGIN
			SET @v_fielddesc = @v_associationtypedesc + ' (' + @v_fielddesc + ')'
		END
