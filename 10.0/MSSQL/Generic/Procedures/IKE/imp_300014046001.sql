/******************************************************************************
**  Name: imp_300014046001
**  Desc: IKE Add/Replace Title Type
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_300014046001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_300014046001]
GO

CREATE PROCEDURE dbo.imp_300014046001 
...
/*  Title Type       */
  ...
  SELECT @v_datacode_org = titletypecode
    FROM book
...
GRANT EXECUTE ON dbo.[imp_300014046001] to PUBLIC 
GO
