/******************************************************************************
**  Name: imp_300024015001
**  Desc: IKE Globalcontact role
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_300024015001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_300024015001]
GO

CREATE PROCEDURE dbo.imp_300024015001 
...
BEGIN
  ...
  if coalesce(@v_new_val,'')<>coalesce(@v_old_val,'')
    begin
      ...
      set @v_errmsg='contact role updated'
    end
  else
    begin
      set @v_errmsg='Globalcontact role unchanged'
    end
...
GRANT EXECUTE ON dbo.[imp_300024015001] to PUBLIC 
GO
