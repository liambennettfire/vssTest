...
IF EXISTS (
		SELECT *
		FROM dbo.sysobjects
		WHERE id = object_id(N'[dbo].[imp_300010426001]')
			AND OBJECTPROPERTY(id, N'IsProcedure') = 1
		)
	DROP PROCEDURE [dbo].[imp_300010426001]
GO

CREATE PROCEDURE dbo.imp_300010426001 
	@i_batch INT
	,@i_row INT
	,@i_dmlkey BIGINT
...
BEGIN
	...
	SET @DEBUG = 1
	IF @DEBUG <> 0 PRINT 'dbo.imp_300010426001'
