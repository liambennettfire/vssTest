/******************************************************************************
**  Name: imp_300026045001
**  Desc: IKE author addr zip
**  Auth: Bennett     
**  Date: 5/9/2016
*******************************************************************************
**  Change History
...
if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[imp_300026045001]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[imp_300026045001]
GO

CREATE PROCEDURE dbo.imp_300026045001 
...
BEGIN
  ...
  if coalesce(@v_orgval,'')<>coalesce(@v_elementval,'')
    begin
      ...
      set @v_errmsg='Author 1 Zip updated'
    end
  else
    begin
      set @v_errmsg='Author 1 Zip unchanged'
    end
...
GRANT EXECUTE ON dbo.[imp_300026045001] to PUBLIC 
GO
