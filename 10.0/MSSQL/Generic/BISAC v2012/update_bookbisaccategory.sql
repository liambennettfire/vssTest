...
DECLARE replacement_cursor CURSOR FOR
    ...
    FROM temp_replacement_codes_2012 
          ...
          WHILE (@@FETCH_STATUS = 0)
            ...
            BEGIN
							 ...
							 UPDATE bookbisaccategory
								  SET bisaccategorycode = @v_replacement_datacode,
									    bisaccategorysubcode =  @v_replacement_datasubcode,
										  lastuserid = 'FB_BISACSUBJECT_UPDATE_2012',
                ...
                BEGIN
								  ...
								  exec qtitle_update_titlehistory 'bookbisaccategory', 'bisaccategorycode' , @v_bookkey, 1, 0, @v_replacement_datacode_desc, 'Update', 'FB_BISACSUBJECT_UPDATE_2012', null,'Bisac Heading', @o_error_code output, @o_error_desc output
							  END
                ...
                BEGIN
								  SET @v_replacement_datasubcode_desc = ltrim(rtrim(dbo.get_subgentables_desc(339, @v_replacement_datacode, @v_replacement_datasubcode, 'long')))
									  exec qtitle_update_titlehistory 'bookbisaccategory', 'bisaccategorysubcode' , @v_bookkey, 1, 0, @v_replacement_datasubcode_desc, 'Update', 'FB_BISACSUBJECT_UPDATE_2012', null,'Bisac Sub Heading', @o_error_code output, @o_error_desc output
						 	  END
