if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_ver_total_net_sales') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_ver_total_net_sales
GO

CREATE PROCEDURE qpl_calc_ver_total_net_sales (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
...
/******************************************************************************************
**  Name: qpl_calc_ver_total_net_sales
...
GRANT EXEC ON dbo.qpl_calc_ver_total_net_sales TO PUBLIC
GO
