if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_yr_discount_dollars') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_yr_discount_dollars
GO

CREATE PROCEDURE qpl_calc_yr_discount_dollars (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
  @i_plyear		INT,
...
/******************************************************************************************
**  Name: qpl_calc_yr_discount_dollars
...
GRANT EXEC ON dbo.qpl_calc_yr_discount_dollars TO PUBLIC
GO
