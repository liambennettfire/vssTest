...
IF OBJECT_ID('dbo.UpdFld_XVQ_Transform_MiscItem_RemoveLeadingZeroes_ZeroIsNull') IS NOT NULL DROP PROCEDURE dbo.UpdFld_XVQ_Transform_MiscItem_RemoveLeadingZeroes_ZeroIsNull
GO
...
CREATE PROCEDURE dbo.UpdFld_XVQ_Transform_MiscItem_RemoveLeadingZeroes_ZeroIsNull  -- for removing leading zeroes from numeric (text) input fields
