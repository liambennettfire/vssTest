IF exists (select * from dbo.sysobjects where id = object_id(N'dbo.POFEEDOUT') and OBJECTPROPERTY(id, N'IsUserTable') = 1)
  DROP TABLE dbo.pofeedout
GO

CREATE TABLE dbo.pofeedout
(
...
create index pofeedout_p1 
    ON dbo.pofeedout (isbn10, printingnumber, ponumber)
GO

GRANT ALL ON dbo.pofeedout TO PUBLIC
GO
