...
BEGIN
  ...
  IF @v_usageclasscode is null OR @v_usageclasscode <= 0 BEGIN
    print 'Could not find usageclasscode for qsicode 9'
    return
  END
 ...
 SELECT @v_count = count(*) 
  ...
  VALUES (@v_new_qsiwindowviewkey, 'Mktg Campaign Default View','Default View for Mktg Campaign',
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Mktg Campaign Categories',
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Mktg Campaign Comments',
         1,0,'Firebrand',getdate(),13,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Mktg Campaign Elements',
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Mktg Campaign Summary',
