...
BEGIN
  ...
  IF @v_usageclasscode is null OR @v_usageclasscode <= 0 BEGIN
    print 'Could not find usageclasscode for qsicode 10'
    return
  END
 ...
 SELECT @v_count = count(*) 
  ...
  VALUES (@v_new_qsiwindowviewkey, 'Mktg Plan Default View','Default View for Mktg Plan',
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Marketing Plan Details',
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Mktg Plan Summary',
         1,0,'Firebrand',getdate(),null,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ...
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('ProjectOrgentry') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Organization Information',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: Organization Information'
  END
 
  SET @v_configobjectkey = 0
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('ReaderInformation') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Reader Information',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: Reader Information'
  END
  ...
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('shPrices') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Prices',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: Prices'
  END
 
  SET @v_configobjectkey = 0
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('shQtyBreakdown') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Quantity Breakdown',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: Quantity Breakdown'
  END
 
  SET @v_configobjectkey = 0
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('shProjectPL') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'P&L Summary',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: P&L Summary'
  END
 
  SET @v_configobjectkey = 0
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('shProdSpecs') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Production Specification',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: Specifications'
  END
  ...
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(configobjectid) = lower('shProjectVerification') 
     and windowid = @v_windowid 
  ...
  IF @v_configobjectkey <> 0 BEGIN
    ...
    INSERT INTO qsiconfigdetail (configdetailkey,configobjectkey,usageclasscode,labeldesc,visibleind,minimizedind, 
                               lastuserid,lastmaintdate,position,path,viewcontrolname,editcontrolname, 
                               qsiwindowviewkey,sectioncontrolname) 
    VALUES (@v_new_configdetailkey,@v_configobjectkey,@v_usageclasscode,'Verification Status',
         0,0,'Firebrand',getdate(),0,
         null,null,null,@v_new_qsiwindowviewkey,
         null)
  END
  ELSE  BEGIN
      print 'Section not found on this database: Verification Status'
  END
 
  SET @v_configobjectkey = 0
  SELECT @v_configobjectkey = configobjectkey 
    FROM qsiconfigobjects 
   WHERE lower(defaultlabeldesc) = lower('Original/Revised Cost Section') 
     and windowid = @v_windowid 
