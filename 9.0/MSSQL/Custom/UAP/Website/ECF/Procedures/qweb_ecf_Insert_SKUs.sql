...
BEGIN
		...
		and b.bookkey = @i_bookkey
				...
				Select @v_title = '('+ UAP.dbo.qweb_get_ISBN(@i_bookkey,'16') + ') ' + Substring (UAP.dbo.qweb_get_Title				(@i_bookkey,'f'),1,84)
				...
				--Select @m_usretailprice = UAP.dbo.qweb_get_BestUSPrice(@i_bookkey,8)
				...
				If exists (Select * 
					...
					begin							 
					Select @m_usretailprice = UAP.dbo.qweb_get_BestUSPrice(@i_bookkey,10)
					end
				Else
					begin
					Select @m_usretailprice = UAP.dbo.qweb_get_BestUSPrice(@i_bookkey,8)
				...
				If (@mediatypecode = 6)
					begin
					Select @m_usretailprice = UAP.dbo.qweb_get_BestUSPrice(@i_bookkey,25)
					end	
