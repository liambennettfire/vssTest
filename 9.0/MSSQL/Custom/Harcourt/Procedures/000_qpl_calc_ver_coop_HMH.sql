if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc062') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc062
GO
 
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_ver_coop_HMH') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_ver_coop_HMH
GO

CREATE PROCEDURE qpl_calc_ver_coop_HMH (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
...
/******************************************************************************************
**  Name: qpl_calc_ver_coop_HMH
**  Desc: Houghton Mifflin Item 62 - Version/Coop.
**
**  Auth: Kate
...
GRANT EXEC ON qpl_calc_ver_coop_HMH TO PUBLIC
GO
