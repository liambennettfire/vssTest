if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_yr_gross_print_sales_HMH') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_yr_gross_print_sales_HMH
GO

CREATE PROCEDURE qpl_calc_yr_gross_print_sales_HMH (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,  
  @i_yearcode   INT,
...
/******************************************************************************************
**  Name: qpl_calc_yr_gross_print_sales_HMH
...
GRANT EXEC ON qpl_calc_yr_gross_print_sales_HMH TO PUBLIC
GO