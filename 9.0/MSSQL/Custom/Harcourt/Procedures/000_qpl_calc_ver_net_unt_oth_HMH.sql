...
GO
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_ver_net_unt_oth_HMH') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_ver_net_unt_oth_HMH
GO

CREATE PROCEDURE qpl_calc_ver_net_unt_oth_HMH (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
...
/******************************************************************************************
**  Name: qpl_calc_ver_net_unt_oth_HMH
**  Desc: Houghton Mifflin Item 17 - Version/Net Units - Other formats.
**
**  Auth: Kate
...
GRANT EXEC ON qpl_calc_ver_net_unt_oth_HMH TO PUBLIC
GO
