...
GO
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_stg_fulfill_HMH') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_stg_fulfill_HMH
GO

CREATE PROCEDURE qpl_calc_stg_fulfill_HMH (    
  @i_projectkey INT,  
  @i_plstage    INT,  
...
/******************************************************************************************  
**  Name: qpl_calc_stg_fulfill_HMH  
**  Desc: HMH - Stage/Fulfillment Costs (% of Gross Print sales).  
**  
**  Auth: Kate  
**  Date: March 10 2014  
...
BEGIN  
  ...
  -- Stage - Gross Print Sales  
  EXEC qpl_calc_stg_gross_print_sales_Discount_Calc_For_Fullfillment_HMH @i_projectkey, @i_plstage, @v_gross_print_sales OUTPUT  
...
Go
Grant all on qpl_calc_stg_fulfill_HMH to Public