IF EXISTS (SELECT * FROM subgentables WHERE tableid = 550 AND datacode = 3 AND datadesc = 'Third Party Rights') BEGIN
	UPDATE subgentables
	   SET qsicode = 49
	 WHERE tableid = 550
	   AND datacode = 3
	   AND datadesc = 'Third Party Rights'
END
go
/******************************************************************************************
...
BEGIN
  ...
  SET @v_newrelatedesc = 'Third Party Rights'
  SET @v_existrelateqsicode = 0
  SET @v_existrelatedesc = 'Third Party Rights'
  SET @v_projroleqsicode = 0
  SET @v_projroledesc= 'Third Party Rights'
