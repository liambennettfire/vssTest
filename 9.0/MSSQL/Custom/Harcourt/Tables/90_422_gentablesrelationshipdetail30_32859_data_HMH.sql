...
BEGIN
	...
	SELECT @v_datadesc1 = datadesc FROM gentables WHERE tableid = 669 and datadesc = 'HMH Mktg Campaign Creation' --TM Web Process Type
	SELECT @v_datadesc2 = datadesc FROM gentables WHERE tableid = 543 and datadesc = 'HMH Mktg Campaign Creation' -- Job Type
