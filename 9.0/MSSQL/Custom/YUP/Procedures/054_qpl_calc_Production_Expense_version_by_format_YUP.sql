...
Create TABLE #Temp_Related_Projects  
(taqprojectkey nvarchar(4000))  
 ...
 END  
  ...
  IF @i_placctgsubcategory IS NULL  
   BEGIN  
    ...
    SET @SQLString_var = N'SELECT @total = SUM(i.versioncostsamount)  
...
Go
Grant all on qpl_calc_Production_Expense_version_by_format_YUP to PUBLIC  