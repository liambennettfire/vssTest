if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qtitle_get_edition_description') and OBJECTPROPERTY(id, N'IsScalarFunction') = 1)
drop function dbo.qtitle_get_edition_description
GO

CREATE FUNCTION dbo.qtitle_get_edition_description (@i_bookkey	INT)
  RETURNS	VARCHAR(120)

/*  
Return a value for editiondescription based on editioncode, editionnumber and additionaleditinfo.
...
GRANT EXECUTE ON dbo.qtitle_get_edition_description TO PUBLIC 
go
