/****** Object:  UserDefinedFunction [dbo].[rpt_get_project_category]    ******/
...
if exists (select * from dbo.sysobjects where id = object_id(N'dbo.rpt_get_project_category') and xtype in (N'FN', N'IF', N'TF'))
  drop function dbo.rpt_get_project_category
GO

CREATE FUNCTION [dbo].[rpt_get_project_category](@i_taqprojectkey	INT,@i_tableid	INT,@i_order INT,@v_column	VARCHAR(1))
RETURNS VARCHAR(255)
...
GRANT EXEC ON dbo.rpt_get_project_category TO PUBLIC
