...
BEGIN
  ...
  BEGIN
    ...
    BEGIN
      ...
      VALUES
        (@v_newkey, 598, @v_datacode, @v_itemtypecode, @v_usageclass, 'QSIDBA', getdate(), 'Copy Participants/Roles from the linked project if any exists and then add any additional Participants/Roles from the Copy From Project')
    END
  END
