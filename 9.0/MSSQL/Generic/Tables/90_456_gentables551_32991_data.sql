...
BEGIN
  ...
  UPDATE gentables
  SET gen1ind = @v_clientoption_autogen, gen2ind = @v_clientoption_allowdups, alternatedesc2 = 'EXEC qean_generate_itemnumber @result OUTPUT, @errorcode OUTPUT, @errordesc OUTPUT'
