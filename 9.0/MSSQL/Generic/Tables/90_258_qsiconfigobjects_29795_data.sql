...
BEGIN  
  ...
  UPDATE qsiconfigobjects SET defaultvisibleind = 0 WHERE configobjectkey = @v_qsiconfigobjectkey	  
  UPDATE qsiconfigdetail SET visibleind = 0 WHERE configobjectkey = @v_qsiconfigobjectkey	
