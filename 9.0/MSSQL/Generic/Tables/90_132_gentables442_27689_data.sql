...
BEGIN
  ...
  SET @v_datacode = 30
  SELECT @v_numericdesc1 = datacode FROM subgentables where tableid = 550 and qsicode = 44
  ...
  IF @v_count = 0 BEGIN	  
    SET @v_datadesc = 'WEB Specification Templates'
    SET @v_datadescshort = 'WEB Spec Templates'
