...
SET @windowname = 'POSummary'
SET @windowtitle = 'Purchase Order Summary'
...
SET @windowname = 'POParticipants'
SET @windowtitle = 'Purchase Order Participants'
SET @windowcategoryid = 133
SET @applicationind = 14
SET @windowind = 'Y'
SET @orgsecurityind = 'N'
