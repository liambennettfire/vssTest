...
Select taqprojectkey, plstagecode, taqversionkey, 'HC List Price' as type, 1 as sortorder,  
...
from taqversion  
UNION  
Select taqprojectkey, plstagecode, taqversionkey, 'PB List Price' as type, 2 as sortorder,  
...
from taqversion  
UNION  
Select taqprojectkey, plstagecode, taqversionkey, 'Ebook List Price' as type, 3 as sortorder,  
