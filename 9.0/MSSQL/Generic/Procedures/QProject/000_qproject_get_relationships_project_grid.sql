...
BEGIN
  ...
  SELECT 1 projectnumber,
    ...
    dbo.qproject_get_misc_float_value( c.projectkey, @v_miscitemkey5 ) miscItem6floatvalue,        
    ...
    @v_datetypecode1 as datetypecode1, dbo.qproject_get_last_taskdate2( c.projectkey, @v_datetypecode1 ) as date1value, 
    @v_datetypecode2 as datetypecode2, dbo.qproject_get_last_taskdate2( c.projectkey, @v_datetypecode2 ) as date2value,
    @v_datetypecode3 as datetypecode3, dbo.qproject_get_last_taskdate2( c.projectkey, @v_datetypecode3 ) as date3value,
    @v_datetypecode4 as datetypecode4, dbo.qproject_get_last_taskdate2( c.projectkey, @v_datetypecode4 ) as date4value,
    @v_datetypecode5 as datetypecode5, dbo.qproject_get_last_taskdate2( c.projectkey, @v_datetypecode5 ) as date5value,
    @v_datetypecode6 as datetypecode6, dbo.qproject_get_last_taskdate2( c.projectkey, @v_datetypecode6 ) as date6value,
    ...
    (SELECT productnumber FROM taqproductnumbers WHERE taqprojectkey = c.projectkey AND productidcode = @v_productidcode1) as productIdCode1Value,
    @v_productidcode2 as productidcode2, 
    (SELECT productnumber FROM taqproductnumbers WHERE taqprojectkey = c.projectkey AND productidcode = @v_productidcode2) as productIdCode2Value,
  ...
  BEGIN 
    ...
    BEGIN
      ...
      IF @v_miscitemtype = 6 OR @v_miscitemtype = 8 OR @v_miscitemtype = 9  --calculated decimal, integer or string
      BEGIN
        EXEC qproject_run_misc_calc @v_otherprojectkey, @v_miscitemkey1, 0, 'QSI', 
          @v_calcvalue OUTPUT, @o_error_code OUTPUT, @o_error_desc OUTPUT
                
        IF @v_calcvalue IS NOT NULL
          UPDATE #temp_relationships
          SET miscItem1value = @v_calcvalue, miscItem1calculatedvalue = @v_calcvalue
    ...
    BEGIN
      ...
      BEGIN
        ...
        IF @v_calcvalue IS NOT NULL
          UPDATE #temp_relationships
          SET miscItem2value = @v_calcvalue, miscItem2calculatedvalue = @v_calcvalue
          WHERE thisprojectkey = @v_thisprojectkey
            AND otherprojectkey = @v_otherprojectkey
            AND thisrelationshipcode = @v_thisrelationshipcode
            AND otherrelationshipcode = @v_otherrelationshipcode
    ...
    BEGIN
      ...
      BEGIN
        ...
        IF @v_calcvalue IS NOT NULL
          UPDATE #temp_relationships
          SET miscItem3value = @v_calcvalue, miscItem3calculatedvalue = @v_calcvalue
          WHERE thisprojectkey = @v_thisprojectkey
            AND otherprojectkey = @v_otherprojectkey
            AND thisrelationshipcode = @v_thisrelationshipcode
            AND otherrelationshipcode = @v_otherrelationshipcode
    ...
    BEGIN
      ...
      BEGIN
        ...
        IF @v_calcvalue IS NOT NULL
          UPDATE #temp_relationships
          SET miscItem4value = @v_calcvalue, miscItem4calculatedvalue = @v_calcvalue
          WHERE thisprojectkey = @v_thisprojectkey
            AND otherprojectkey = @v_otherprojectkey
            AND thisrelationshipcode = @v_thisrelationshipcode
            AND otherrelationshipcode = @v_otherrelationshipcode
    ...
    BEGIN
      ...
      BEGIN
        ...
        IF @v_calcvalue IS NOT NULL
          UPDATE #temp_relationships
          SET miscItem5value = @v_calcvalue, miscItem5calculatedvalue = @v_calcvalue
          WHERE thisprojectkey = @v_thisprojectkey
            AND otherprojectkey = @v_otherprojectkey
            AND thisrelationshipcode = @v_thisrelationshipcode
            AND otherrelationshipcode = @v_otherrelationshipcode
    ...
    BEGIN
      ...
      BEGIN
        ...
        IF @v_calcvalue IS NOT NULL
          UPDATE #temp_relationships
          SET miscItem6value = @v_calcvalue, miscItem6calculatedvalue = @v_calcvalue
          WHERE thisprojectkey = @v_thisprojectkey
            AND otherprojectkey = @v_otherprojectkey
            AND thisrelationshipcode = @v_thisrelationshipcode
            AND otherrelationshipcode = @v_otherrelationshipcode
  ...
  SELECT *
  FROM #temp_relationships
  ORDER BY keyind DESC, sortorder ASC, thisrelationshipcode ASC, otherrelationshipcode ASC
