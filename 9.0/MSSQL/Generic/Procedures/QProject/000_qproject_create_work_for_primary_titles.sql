  ...
  WHILE @@fetch_status = 0 BEGIN
    ...
    IF @v_count > 0 BEGIN
      ...
      IF @v_title_acq_projectkey > 0 BEGIN
        ...
        exec qproject_create_work @v_title_acq_projectkey,0,@v_taqprojectowner_userid,@projecttitle_var,@v_work_projectkey output,@error_var output,@error_desc output
