 IF EXISTS (SELECT * FROM sysobjects WHERE type = 'P' AND name = 'qproject_get_relationship_roles_for_tab')
  BEGIN
    PRINT 'Dropping Procedure qproject_get_relationship_roles_for_tab'
    DROP  Procedure  qproject_get_relationship_roles_for_tab
  END

GO

PRINT 'Creating Procedure qproject_get_relationship_roles_for_tab'
GO

CREATE PROCEDURE qproject_get_relationship_roles_for_tab
 (@i_table1id             integer,
...
/******************************************************************************
**  Name: qproject_get_relationship_roles_for_tab
**  Desc: This stored procedure returns gentable values for roles
**        by relationship tab.
**
**  Auth: Alan Katzen
...
GRANT EXEC ON qproject_get_relationship_roles_for_tab TO PUBLIC
GO
