if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qproject_get_volume_for_issue') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qproject_get_volume_for_issue
GO
...
CREATE PROCEDURE qproject_get_volume_for_issue
...
/******************************************************************************
**  Name: qproject_get_volume_for_issues
**  Desc: 
**
**    Auth: Jon Hess
**    Date: 7/24/2008
...
-- First thing to do is convert the issuekey to volume key.
 ...
 SET @v_volumeKey = ( select volumekey from dbo.qproject_get_issue() where issuekey = @i_projectkey )
...
GRANT EXEC ON qproject_get_volume_for_issue TO PUBLIC
GO
