if exists (select * from dbo.sysobjects where id = object_id(N'dbo.qpl_calc_ver_cv_pctof_netsales') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
  drop procedure dbo.qpl_calc_ver_cv_pctof_netsales
GO


CREATE PROCEDURE [dbo].[qpl_calc_ver_cv_pctof_netsales] (  
  @i_projectkey INT,
  @i_plstage    INT,
  @i_plversion	INT,
...
/******************************************************************************************
**  Name: qpl_calc_ver_cv_pctof_netsales

**  Desc: Generic Version calculation which multiples a client value * net sales 
...
GRANT EXEC ON qpl_calc_ver_cv_pctof_netsales TO PUBLIC
GO