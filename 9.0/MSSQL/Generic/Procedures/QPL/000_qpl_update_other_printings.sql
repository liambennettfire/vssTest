      ...
      BEGIN
        ...
        BEGIN
          ...
          BEGIN
            ...
            SELECT @v_externalcode = LTRIM(RTRIM(LOWER(externalcode)))
            FROM cdlist
            ...
            BEGIN
              INSERT INTO taqversioncosts
                ...
                lastuserid, lastmaintdate, acceptgenerationind, plcalccostsubcode, taqversionspeccategorykey)
              VALUES
                (@v_formatyearkey, @i_chargecode, @i_newcalctype, @i_newnote, @v_printingnumber,
                @i_userid, getdate(), 0, @i_plcalccostsubcode, @i_taqversionspeccategorykey)     
