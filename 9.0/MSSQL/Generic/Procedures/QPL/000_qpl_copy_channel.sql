...
BEGIN
  ...
  BEGIN
    ...
    SELECT @v_cur_saleskey = taqversionsaleskey, @v_discountpercent = discountpercent, @v_returnpercent = returnpercent
    ...
    VALUES
      ...
      @i_from_channel, @i_from_subchannel, @v_discountpercent, @v_returnpercent, @i_userid, getdate())
