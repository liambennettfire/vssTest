...
-- ====================================================================
CREATE PROCEDURE qcs_execute_syncpostprocess_for_book @bookkey int
AS
BEGIN
	...
	EXEC qtitle_set_cspartnerstatuses_on_title @bookkey, 'Cloud', @error_code OUTPUT, @error_desc OUTPUT
