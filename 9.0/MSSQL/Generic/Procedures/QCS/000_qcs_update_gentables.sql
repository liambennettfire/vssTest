              ...
              IF @datacode > 0 BEGIN
                SELECT @CountVar = count(*)
                 ...
                 WHERE tableid = @i_tableid
                   ...
                   AND datasubcode = 0
                   AND datasub2code = 0
                   AND itemtypecode = @i_itemtypefilter
                ...
                IF @CountVar = 0 BEGIN
                  ...
                  IF @newkey > 0 BEGIN
                    INSERT INTO gentablesitemtype (gentablesitemtypekey,tableid,datacode,datasubcode,datasub2code,
                                                   ...
                                                   sortorder)
                                           VALUES (@newkey,@i_tableid,@datacode,0,0,@i_itemtypefilter,0,0,'Cloud',getdate(),0)
