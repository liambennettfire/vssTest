...
**    --------    --------       -------   --------------------------------------
**   12/10/2014   Uday A.Khisty  30701     Copy Specification Templates
*******************************************************************************/
	  ...
	  DECLARE taqversionformat_cursor CURSOR FOR
		...
		BEGIN  			
		  EXEC qspec_apply_specificationtemplate @v_projectkey, @v_templateprojectkey
			,@v_TaqProjectFormatKey, @v_itemtypecode, @v_usageclasscode, @i_userid, 2, @o_error_code OUTPUT, @o_error_desc OUTPUT		
