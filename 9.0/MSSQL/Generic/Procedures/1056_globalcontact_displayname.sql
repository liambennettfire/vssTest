...
if @v_displayname_format  = 0 begin
	...
	set @v_displayname = @v_lastname + @v_comma + @v_firstname + @v_space + @v_middlename_innitial 
end
if @v_displayname_format  = 1 begin
	if @v_firstname_innitial = '' begin 
		set @v_comma = '' 
	end
	set @v_displayname = @v_lastname + @v_comma + @v_firstname_innitial
end 
...
if @v_displayname_format  = 3 begin
	...
	set @v_displayname = @v_firstname + @v_space + @v_middlename_innitial + @v_space2 + @v_lastname
end
