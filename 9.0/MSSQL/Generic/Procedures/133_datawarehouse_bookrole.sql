...
DECLARE warehouserole INSENSITIVE CURSOR
FOR
		SELECT b.roletypecode,b.depttypecode,resourcedesc,displayname,
		firstname,lastname, middlename,shortname
...
INTO @i_roletypecode,@i_depttypecode,@c_resourcedesc,
@c_displayname,@c_firstname,@c_lastname,@c_middlename,
@c_shortname
...
INSERT INTO  whtitlepersonnel
	(bookkey,displayname1,firstname1,lastname1,displayname2,firstname2,
...
VALUES (@ware_bookkey,@ware_displayname1,@ware_firstname1,@ware_lastname1,
