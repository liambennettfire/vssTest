    ...
    begin
      ...
      IF (@i_corparateind = 1)
        BEGIN
          ...
          values
           (@i_authorkey,@i_displayname,upper(@i_lastname),@i_firstname,@i_lastname,@i_middlename,@i_ssn,@i_degree,@i_suffix,@i_accreditationcode,@i_uscitizenind,@i_lastuserid,getdate(),0,0,0,@i_lastname,@i_activeind)      
        END
      ELSE
        BEGIN
          insert into globalcontact
          ...
          values
            (@i_authorkey,@i_displayname,upper(@i_lastname),@i_firstname,@i_lastname,@i_middlename,@i_ssn,@i_degree,@i_suffix,@i_accreditationcode,@i_uscitizenind,@i_lastuserid,getdate(),1,0,0,@i_activeind)        
        END
    end 
  else
    begin
