...
BEGIN
  ...
  if @v_rows = 0 or @v_rows is null
    insert into corecontactinfo
      ...
      relatedcontactkey1, relatedcontactname1, relatedcontactkey2, relatedcontactname2, lastmaintdate)
    values
      (@i_contactkey, @v_displayname,  @v_privatind,@v_email, @v_phone, @v_keyroles, @v_keycategories, null, @v_owneruserkey,
      @v_relatedcontactkey1, @v_relatedcontactname1, @v_relatedcontactkey2, @v_relatedcontactname2, getdate())
