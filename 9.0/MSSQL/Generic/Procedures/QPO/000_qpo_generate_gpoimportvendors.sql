...
BEGIN
 ...
 SELECT @v_misckey = misckey FROM bookmiscitems WHERE qsicode = 20 --Import Country
 ...
 IF @v_importcountry > 0 BEGIN
  SELECT @v_importcountry_desc = datadesc FROM gentables WHERE tableid = 114 AND datacode = @v_importcountry
 END
