 ...
 IF @v_count > 0 BEGIN
	...
	FETCH taqprojectcontactrole_cur INTO @v_taqprojectcontactrolekey, @v_taqprojectcontactkey, @v_shipquantity,@v_shippingmethodcode,
     ...
     -- datacode for Pariticipant by Role2 section (7) and datasubcode = date (11)
	   ...
	   VALUES (@i_gpokey,coalesce(@i_sectionkey,0),@v_globalcontactkey,@v_detaillinenbr,@v_shiptoname,/*@v_shiptoaddress1,*/ --changed for hna
	     @v_shiptoaddress2,@v_shiptoaddress3,null,@v_shiptocity,@v_shiptostate,@v_shiptozipcode,@v_shiptoattn,
