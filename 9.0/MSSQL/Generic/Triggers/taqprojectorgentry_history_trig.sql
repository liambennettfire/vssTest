IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'taqprojectorgentry_history')
	BEGIN
		DROP  Trigger dbo.taqprojectorgentry_history
	END
GO

CREATE TRIGGER [dbo].taqprojectorgentry_history ON [dbo].taqprojectorgentry
