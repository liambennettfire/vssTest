IF EXISTS (SELECT * FROM sysobjects WHERE type = 'TR' AND name = 'taqprojectcontact_history')
	BEGIN
		DROP  Trigger dbo.taqprojectcontact_history
	END
GO

CREATE TRIGGER [dbo].taqprojectcontact_history ON [dbo].taqprojectcontact
